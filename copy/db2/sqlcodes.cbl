      ...
      * Revalidation failed for one or more objects
       78  SQL-RC-W361               VALUE    361.
      ...
      * Type-1 indexes exist
       78  SQL-RC-W1498              VALUE    1498.
      * Upgrade warning about additional user action
       78  SQL-RC-W1499              VALUE    1499.

      * An enabled workload is associated with a disabled service class
       78  SQL-RC-W1528              VALUE    1528.
      ...
      * Log archive compression is not fully enabled.
       78  SQL-RC-W1663              VALUE    1663.
      * Unexpected warning code <string> received from in-database analytics
      * provider <string>. Associated text and and tokens: <string>
       78  SQL-RC-W1664              VALUE    1664.
      ...
      * Error SQLCODE for the db2logicalbar utility
      * Logical backup utility has completed successfully, timestamp for the
      * backup image is "<timestamp>"
       78  SQL-RC-I1796              VALUE    1796.
      * A database configuration parameter depends on a feature that is
      * disabled
       78  SQL-RC-W1795              VALUE    1795.

      * Remote column was reduced
       78  SQL-RC-W1812              VALUE    1812.
      ...
      * Even number of hosts detected with no qdevice
       78  SQL-RC-W1902              VALUE    1902.
      * Automatic statistics profiling has been disabled for the specified
      * connection
       78  SQL-RC-W2088              VALUE    2088.
      * Rebalance did not move data or not all stripe sets have a container
       78  SQL-RC-W2094              VALUE    2094.
      * Storage path placed into drop pending state
       78  SQL-RC-W2095              VALUE    2095.
      ...
      * The row-level Bernolli sampling was done instead of System
      * page-level sampling
       78  SQL-RC-W2317              VALUE    2317.

      * The database, "<database-name>", was successfully created. However,
      * the database configuration was not automatically  tuned for your
      * system resources.
       78  SQL-RC-W1746              VALUE    1746.

      * Informational and warning SQLCODEs for the ingest utility

      * One or more of the table's distribution keys does not correspond to
      * a field in the field definition list or corresponds to more than one
      * field.
       78  SQL-RC-W2900              VALUE    2900.
      * The INGEST command completed with "number" errors and "number"
      * warnings. Messages are in file "filename".
       78  SQL-RC-I2901              VALUE    2901.
      * The INGEST command completed with "number" errors and "number"
      * warnings.
       78  SQL-RC-I2902              VALUE    2902.
      * Configuration parameter "<parameter>" has been automatically
      * adjusted to the following value: "<value>". Reason
      * code="<reason-code>".
       78  SQL-RC-W2903              VALUE    2903.
      * The field value at line number "<line-number>" and byte position
      * "<byte-position>" was truncated because the data is longer than the
      * field length.
       78  SQL-RC-W2904              VALUE    2904.
      * The following error occurred issuing the SQL "<sql-statement>"
      * statement on table "<table-name>" using data from line
      * "<line-number>" of input file "<file-name>".
       78  SQL-RC-I2905              VALUE    2905.
      * The following error occurred issuing the SQL "<sql-statement>"
      * statement on table "<table-name>" using data from line
      * "<line-number>" of pipe "<pipe-name>".
       78  SQL-RC-I2906              VALUE    2906.
      * The following error occurred issuing the SQL "<sql-statement>"
      * statement on table "<table-name>" using data from line
      * "<line-number>" of TCP/IP port "<port-number>".
       78  SQL-RC-I2907              VALUE    2907.
      * The following error occurred while formatting data from pipe
      * "<pipe-name>".
       78  SQL-RC-I2908              VALUE    2908.
      * The following error occurred while formatting data from TCP/IP port
      * "<port-number>".
       78  SQL-RC-I2909              VALUE    2909.
      * The ingest utility has started the following ingest job: "<job-ID>".
       78  SQL-RC-I2914              VALUE    2914.
      * The following error occurred while formatting data from input file
      * "<file-name>".
       78  SQL-RC-I2922              VALUE    2922.
      * The field value at line number "<line-number>" and field number
      * "<field-number>" will be truncated because the data is longer than
      * the field length.
       78  SQL-RC-W2935              VALUE    2935.
      * The utility recovered from the following error.  Reason code
      * "<reason-code>". Number of reconnects: "<number>". Number of
      * retries: "<number>".
       78  SQL-RC-W2959              VALUE    2959.
      * The following warning or error occurred issuing the SQL
      * "<sql-statement>" statement on table "<table-name>".
       78  SQL-RC-I2965              VALUE    2965.
      * The following warning or error occurred connecting to the database. 
      * Database name or local alias: "<dbname>".  User ID: "<user-ID>"
       78  SQL-RC-I2966              VALUE    2966.
      * The following warning or error occurred connecting to a database
      * partition. Partition number: "<number>". Database name on the
      * server: "<dbname>". Host name: "<hostname>". Service name or port
      * number: "<service-name-or-port-number>". User ID: "<user-ID>".
       78  SQL-RC-I2967              VALUE    2967.
      * Field "<field-name>" specifies conflicting values for the length and
      * end position.  Reason code "<reason-code>".
       78  SQL-RC-W2976              VALUE    2976.
      * Because of the previous error, the ingest utility will exit.
       78  SQL-RC-I2977              VALUE    2977.
      * The following error occurred and the ingest utility could not
      * recover after "<number>" reconnects and "<number>" retries.  Reason
      * code: "<reason-code>".
       78  SQL-RC-I2978              VALUE    2978.
      * The ingest utility is starting at "<timestamp>".
       78  SQL-RC-I2979              VALUE    2979.
      * The ingest utility completed successfully at "<timestamp>".
       78  SQL-RC-I2980              VALUE    2980.
      * Authorization ID "<auth-ID>" is not currently running any INGEST
      * commands.
       78  SQL-RC-W2982              VALUE    2982.
      ...
      * priority of dft sys serviceclass is too low
       78  SQL-RC-W4728              VALUE    4728.
      * The statement completed, but some rows were rejected.
       78  SQL-RC-W5108              VALUE    5108.
      * data change operation adjusted value for a period
       78  SQL-RC-W5191              VALUE    5191.
      * The primary diagnostic directory path and the alternate diagnostic
      * directory path use the same file system
       78  SQL-RC-W5190              VALUE    5190.
      ...
      * Routine has completed, but at least one error was encountered during
      * its execution
       78  SQL-RC-W20397             VALUE    20397.
      * The statement compilation was successful but the access plan for
      * this statement could not be preserved
       78  SQL-RC-W20516             VALUE    20516.
      * One or more tables in the schema have a different attribute than the
      * schema
       78  SQL-RC-W20534             VALUE    20534.
      ...
      * The newly defined object is marked invalid
       78  SQL-RC-W20480             VALUE    20480.
      * A permission or mask was changed for the table named "table-name"
      * and this might require a change to the permissions or masks of a
      * materialized query table based on this table to maintain the
      * security of the data
       78  SQL-RC-W20538             VALUE    20538.
      * Data distribution in random distribution table might be sub-optimal.
       78  SQL-RC-W20568             VALUE    20568.
      ...
      * A memory allocation error has occurred.
       78  SQL-RC-E83                VALUE    -83.
      * bad SQL statement
       78  SQL-RC-E084               VALUE    -84.
      * Duplicate SQL statement name
       78  SQL-RC-E085               VALUE    -85.
      * Invalid context for NULL
       78  SQL-RC-E087               VALUE    -87.
      ...
      * DSN not found in db2dsdriver.cfg
       78  SQL-RC-E1531              VALUE    -1531.
      ...
      * Extended indicator value out of range
       78  SQL-RC-E363               VALUE    -363.
      * Invalid use of extended indicator
       78  SQL-RC-E365               VALUE    -365.
      * DataLink Error
      ...
      * operation on fed three-part name not allowed
       78  SQL-RC-E512               VALUE    -512.
      * cursor not prepared
      ...
      * Temporal constraint cannot be dropped
       78  SQL-RC-E784               VALUE    -784.
      ...
      * An invalid operating system operation was attempted by a UTL_FILE
      * module routine
       78  SQL-RC-E949               VALUE    -949.
      ...
      * request error because of an error or interrupt
       78  SQL-RC-E1224              VALUE    -1224.
      ...
      * not support DATALINK
       78  SQL-RC-E1249              VALUE    -1249.
      ...
      * One or more of the parameters submitted for immediate modification
      * could not be changed dynamically and have been rolled back
       78  SQL-RC-E1378              VALUE    -1378.
      ...
      * Invalid object for operation
       78  SQL-RC-E1412              VALUE    -1412.
      * Wrapper release not compatible with DB2 release
       78  SQL-RC-E1416              VALUE    -1416.
      * Function not supported on shared data
       78  SQL-RC-E1419              VALUE    -1419.
      ...
      * Unable to allocate new transport
       78  SQL-RC-E1509              VALUE    -1509.
      * Invalid clause for service subclass
       78  SQL-RC-E1511              VALUE    -1511.
      * Single member db2start with the ADMIN MODE option is not supported
      * in a shared data environment
       78  SQL-RC-E1514              VALUE    -1514.
      * UM cannot be created due to conflict
       78  SQL-RC-E1515              VALUE    -1515.
      * Alter server cannot add FED_PROXY_USER due to conflict
       78  SQL-RC-E1516              VALUE    -1516.
      * The database could not be deactivated due to an error at one or more
      * members
       78  SQL-RC-E1522              VALUE    -1522.
      * Extent movement is in progress
       78  SQL-RC-E1523              VALUE    -1523.
      * Keyword not supported in a shared data environment
       78  SQL-RC-E1538              VALUE    -1538.
      * Tablespace or Storage group is not accessible on the current member
       78  SQL-RC-E1540              VALUE    -1540.
      ...
      * The SYSINSTALLOBJECTS procedure failed to migrate the explain tables
       78  SQL-RC-E1563              VALUE    -1563.
      * LIST TABLESPACES deprecated
       78  SQL-RC-E1554              VALUE    -1554.
      * Change object storage deletes suspend state failed
       78  SQL-RC-E1555              VALUE    -1555.
      * Recovery not supported between incompatible configurations or
      * topologies
       78  SQL-RC-E1564              VALUE    -1564.
      * Exclusive connections to a single partition in a data sharing
      * environment are not supported.
       78  SQL-RC-E1567              VALUE    -1567.
      * invalid database partitions
       78  SQL-RC-E1569              VALUE    -1569.
      * The database rollforward or group crash recovery has failed because
      * of a disk full situation.
       78  SQL-RC-E1572              VALUE    -1572.
      * Database cannot be activated as it must be upgraded for use in a
      * shared data environment
       78  SQL-RC-E1573              VALUE    -1573.
      * The ADD MEMBER or DROP MEMBER command failed because the database
      * would have become unrecoverable
       78  SQL-RC-E1575              VALUE    -1575.
      * The database removal failed because of a cluster manager error.
       78  SQL-RC-E1576              VALUE    -1576.
      * The STANDALONE parameter is not supported with the START command in
      * a DB2 pureCluster environment
       78  SQL-RC-E1577              VALUE    -1577.
      * The RESTART parameter is not supported with the START command in a
      * DB2 pureCluster environment
       78  SQL-RC-E1578              VALUE    -1578.
      ...
      * operation failed due to host is a CF
       78  SQL-RC-E1587              VALUE    -1587.
      * The current member cannot process data change statements because of
      * an error on another member.
       78  SQL-RC-E1588              VALUE    -1588.
      * An operating system resource limit was reached
       78  SQL-RC-E1589              VALUE    -1589.
      ...
      * The specified DB2 configuration parameter is discontinued
       78  SQL-RC-E1597              VALUE    -1597.
      * 'connect' connection failed, license not found
       78  SQL-RC-E1598              VALUE    -1598.
      * Public synonym not supported in SAP workload
       78  SQL-RC-E1599              VALUE    -1599.
      * The current default storage group cannot be dropped
       78  SQL-RC-E1600              VALUE    -1600.
      ...
      * Event monitor may not have started or may not have started with full
      * restart capability
       78  SQL-RC-E1636              VALUE    -1636.
      * specified clause is not supported with transparent DDL
       78  SQL-RC-E1637              VALUE    -1637.
      * Redirecting storage group paths is not possible.
       78  SQL-RC-E1638              VALUE    -1638.
      * Security-related files do not have required OS permissions
       78  SQL-RC-E1639              VALUE    -1639.
      * usage list cannot be defined for object
       78  SQL-RC-E1640              VALUE    -1640.
      * File system mounted incorrectly with nosuid
       78  SQL-RC-E1641              VALUE    -1641.
      * Insufficient instance_memory for allocation
       78  SQL-RC-E1643              VALUE    -1643.
      * The SQL statement or command/utility cannot be processed because of
      * the state of member "member-id" in a DB2 pureCluster environment.
       78  SQL-RC-E1648              VALUE    -1648.

      * Tolerated physical read error.
       78  SQL-RC-E1655              VALUE    -1655.
      * Tolerated page inconsistency error.
       78  SQL-RC-E1656              VALUE    -1656.

      * Log archive compression failed while archiving or retrieving log
      * file
       78  SQL-RC-E1662              VALUE    -1662.
      * Log archive compression is disallowed when raw devices are used for
      * database logging.
       78  SQL-RC-E1665              VALUE    -1665.
      * HADR primary db deactivated in disconnected peer state
       78  SQL-RC-W1657              VALUE    1657.
      * Command option is not supported on a sharing-data instance.
       78  SQL-RC-E1694              VALUE    -1694.
      * Command option is not supported on a non-sharing-data instance.
       78  SQL-RC-E1695              VALUE    -1695.

      * db2start failed for rolling updates reasons.
       78  SQL-RC-E1698              VALUE    -1698.

      * Information could not be found on the HADR Standby database
       78  SQL-RC-E1661              VALUE    -1661.
      * CREATE TABLE failed for CDE: unsupported
       78  SQL-RC-E1666              VALUE    -1666.
      * Operation not supported for CDE
       78  SQL-RC-E1667              VALUE    -1667.
      * Ignored functionality in CDE
       78  SQL-RC-W1669              VALUE    1669.
      * Success but some tables organized by row
       78  SQL-RC-W1672              VALUE    1672.
      * Feature is incompatible with CDE
       78  SQL-RC-E1676              VALUE    -1676.
      * The specified member subset attribute is not valid
       78  SQL-RC-E1699              VALUE    -1699.
      * RANDOM keyword cannot be used with column
       78  SQL-RC-E1709              VALUE    -1709.
      * Dropping the member failed because the specified member is the only
      * member in the member subset. The last member cannot be dropped.
       78  SQL-RC-E1716              VALUE    -1716.
      * Connection to the database alias rejected because the member subset
      * is disabled.
       78  SQL-RC-E1717              VALUE    -1717.
      * The attempt to uncatalog the database alias "database_alias" using
      * the UNCATALOG DB command failed.
       78  SQL-RC-E1718              VALUE    -1718.
      * cannot specify automatic with member instance memory
       78  SQL-RC-E1722              VALUE    -1722.
      * File system caching is not supported in the current environment
       78  SQL-RC-E1723              VALUE    -1723.
      * The command or operation failed because the keystore could not be
      * accessed. Reason code: "reason-code".
       78  SQL-RC-E1728              VALUE    -1728.
      * The command failed because the label "label" does not exist in the
      * keystore.
       78  SQL-RC-E1729              VALUE    -1729.
      * The command or operation failed because the label "label" stored in
      * the "file"."file_type" file does not exist in the keystore.
       78  SQL-RC-E1730              VALUE    -1730.
      * The operation failed because of an error determining the data
      * encryption key. File type: "file_type", file "file".
       78  SQL-RC-E1731              VALUE    -1731.
      * The command failed because the specified encryption options are not
      * valid.
       78  SQL-RC-E1732              VALUE    -1732.
      * The command or operation failed because the specified master key
      * label is too long.
       78  SQL-RC-E1733              VALUE    -1733.
      * The command or operation failed because the master key does not
      * match a supported key length.
       78  SQL-RC-E1734              VALUE    -1734.
      * The RESTORE command failed because encryption key label specified in
      * the command does not match the label used to encrypt the backup
      * image.
       78  SQL-RC-E1735              VALUE    -1735.
      * The command failed to retrieve the keystore password. Reason code
      * "reason-code".
       78  SQL-RC-E1736              VALUE    -1736.
      * The command or operation failed because the database is not
      * encrypted.
       78  SQL-RC-E1737              VALUE    -1737.
      * The command or operation failed because the master key label was not
      * provided.
       78  SQL-RC-E1738              VALUE    -1738.
      * The command or operation failed because ENCROPTS specifies
      * unrecognized values.
       78  SQL-RC-E1739              VALUE    -1739.
      * The command or operation failed because the key rotation operation
      * failed. Reason code "reason-code".
       78  SQL-RC-E1740              VALUE    -1740.
      * The command or operation failed because the master key for master
      * key label "label" has changed.
       78  SQL-RC-E1741              VALUE    -1741.
      * The API does not support reading encrypted logs.
       78  SQL-RC-E1745              VALUE    -1745.
      * The statement failed because it references a type "type-name" which
      * was generated for an array or row column definition.
       78  SQL-RC-E1749              VALUE    -1749.
      * Severe failure in IUD operation on htable.
      ...
      * functionality not supported for database code page and collation
       78  SQL-RC-E1780              VALUE    -1780.
      * An error occurred while parsing the external keystore configuration
      * file
       78  SQL-RC-E1781              VALUE    -1781.
      * The command or operation failed because an error was encountered
      * accessing the centralized key manager. Reason code: "reason-code".
       78  SQL-RC-E1782              VALUE    -1782.
      * The command or operation failed because an error was encountered
      * accessing the PKCS #11 key manager. Reason code: "reason-code".
       78  SQL-RC-E1783              VALUE    -1783.
      * BLU object inaccessible with current code level
       78  SQL-RC-E1784              VALUE    -1784.
      * Model could not be reverted
       78  SQL-RC-E1793              VALUE    -1793.
      * No models defined for associated object
       78  SQL-RC-E1794              VALUE    -1794.

      * operation cannot be executed in No Package Lock mode
       78  SQL-RC-E1803              VALUE    -1803.
      * Federated Two Phase Commit is not supported
       78  SQL-RC-E1811              VALUE    -1811.
      ...
      * ALLOW READ/WRITE access mode not allowed for the reorg operation
       78  SQL-RC-E1548              VALUE    -1548.
      * partition level REORG TABLE not allowed when table is in reorg
      * pending state and has nonpartitioned indexes defined
       78  SQL-RC-E1549              VALUE    -1549.

      * LONG not allowed on devices
       78  SQL-RC-E1590              VALUE    -1590.
      * Snapshot buffer size is greater than the maximum allowed
       78  SQL-RC-E1635              VALUE    -1635.
      * Quiesce operation failed
       78  SQL-RC-E1658              VALUE    -1658.
      * Operation not supported with this environment
       78  SQL-RC-E1668              VALUE    -1668.
      * The HBase table was not created because a TERMINATED BY character
      * separator-char was invalid
       78  SQL-RC-E1775              VALUE    -1775.
      * The HBase table was not created or altered because the column
      * mapping is not valid
       78  SQL-RC-E1778              VALUE    -1778.
      * Java class class-name of type class-type could not be loaded
       78  SQL-RC-E1779              VALUE    -1779.
      * Incompatible extended index detected
       78  SQL-RC-E1785              VALUE    -1785.
      * Specified definition, schema, or nickname does not exist
       78  SQL-RC-E1791              VALUE    -1791.

      * generic utility error, currently only used by logicalbar
      * The "<utility name>" utility has failed with error "<error text>".
       78  SQL-RC-E1797              VALUE    -1797.

      * Added maximum number of columns to a table
       78  SQL-RC-E1798              VALUE    -1798.
      * Federation is not supported for XML data when the Database
      * Partitioning Feature is enabled
       78  SQL-RC-E1815              VALUE    -1815.
      ...
      * not consistent with remote semantics
       78  SQL-RC-W1865              VALUE    1865.
      ...
      * a value less than 1, a duplicate value, or the values are not in
      * ascending order
       78  SQL-RC-E1510              VALUE    -1510.

      * Parameter incorrectly specified
       78  SQL-RC-E2032              VALUE    -2032.
      * The path for the file or device "path/device" is not valid.
       78  SQL-RC-E2036              VALUE    -2036.
      * Unable to start a child process or thread.
       78  SQL-RC-E2043              VALUE    -2043.
      * An error occurred while accessing a message queue. Reason code:
      * "reason-code".
       78  SQL-RC-E2044              VALUE    -2044.
      * CF structure resize timed out
       78  SQL-RC-E2046              VALUE    -2046.
      * CF_DB_MEM_SZ cannot exceed CF_MEM_SZ
       78  SQL-RC-E2047              VALUE    -2047.
      * Insufficient CF memory to satisfy request (see reason code)
       78  SQL-RC-E2049              VALUE    -2049.
      * Communication failure between DB2 and the CF server encountered (see
      * reason code)
       78  SQL-RC-E2051              VALUE    -2051.
      * Backup unable to obtain metadata from one or more remote members
       78  SQL-RC-E2052              VALUE    -2052.
      * The media "media" is already opened by another process.
       78  SQL-RC-E2057              VALUE    -2057.
      * An attempt to access media "media" is denied.
       78  SQL-RC-E2061              VALUE    -2061.
      ...
      * Only one work action set can be defined for a service class
       78  SQL-RC-E2084              VALUE    -2084.
      * Cannot use default subclass for work action set mapping
       78  SQL-RC-E2085              VALUE    -2085.
      * Invalid range for FROM and TO parameter
       78  SQL-RC-E2086              VALUE    -2086.
      * Connection attribute cannot be dropped from workload definition
       78  SQL-RC-E2089              VALUE    -2089.
      * Workload cannot be dropped
       78  SQL-RC-E2090              VALUE    -2090.
      * Not enough space on storage paths to rebalance
       78  SQL-RC-E2091              VALUE    -2091.
      * Storage path already in drop pending state
       78  SQL-RC-E2092              VALUE    -2092.
      * Cannot drop last storage path
       78  SQL-RC-E2093              VALUE    -2093.
      * Threshold cannot be dropped
       78  SQL-RC-E2096              VALUE    -2096.
      * Cannot perform requested operation while schema transport is running
       78  SQL-RC-E2098              VALUE    -2098.

      * The ADMIN_MOVE_TABLE procedure not completed because of an
      * incompatibility
       78  SQL-RC-E2101              VALUE    -2101.
      * The ADMIN_MOVE_TABLE procedure not completed because of an internal
      * error
       78  SQL-RC-E2102              VALUE    -2102.
      * The ADMIN_MOVE_TABLE procedure not completed because table not
      * supported
       78  SQL-RC-E2103              VALUE    -2103.
      * The ADMIN_MOVE_TABLE procedure not completed because of user or
      * action
       78  SQL-RC-E2104              VALUE    -2104.
      * The ADMIN_MOVE_TABLE procedure not completed because prereq not
      * satisfied
       78  SQL-RC-E2105              VALUE    -2105.
      ...
      * The specified table does not exist.
       78  SQL-RC-E2211              VALUE    -2211.
      * Incompatible request to reclaim extents
       78  SQL-RC-E2221              VALUE    -2221.
      * Rebuild synopsis table failed
       78  SQL-RC-E2223              VALUE    -2223.
      * The synopsis table for the specified table does not exist
       78  SQL-RC-E2224              VALUE    -2224.
      * A statistics profile does not exist
       78  SQL-RC-E2315              VALUE    -2315.

      * Restore operation cannot be completed due to transport schema error
       78  SQL-RC-E2590              VALUE    -2590.
      * Cannot rebind as the object the package generated for is invalid
       78  SQL-RC-E2453              VALUE    -2453.
      * table space maximum size exceeded during rollforward
       78  SQL-RC-E2434              VALUE    -2434.
      * Hidden column behavior not specified for utility operation
       78  SQL-RC-E2437              VALUE    -2437.
      * The db2updvXX tool needs to be run to update routine definitions
       78  SQL-RC-E2439              VALUE    -2439.

      * Error SQLCODEs for the db2convert utility

      * table conversion error
       78  SQL-RC-E2441              VALUE    -2441.
      * invalid db2convert command parameter
       78  SQL-RC-E2442              VALUE    -2442.
      * the db name is not specified
       78  SQL-RC-E2443              VALUE    -2443.
      * no corresponding convert operation for -continue
       78  SQL-RC-E2444              VALUE    -2444.
      * no satisfied tables
       78  SQL-RC-E2445              VALUE    -2445.
      * completed successfully
       78  SQL-RC-I2446              VALUE    2446.
      * completed successfully but failed for some tables
       78  SQL-RC-W2447              VALUE    2447.
      * failed to convert any tables
       78  SQL-RC-E2448              VALUE    -2448.
      * no tables are row-organized
       78  SQL-RC-W2449              VALUE    2449.
      * completed successfully for INIT,COPY,REPLAY
       78  SQL-RC-I2450              VALUE    2450.
      * completed successfully for INIT,COPY,REPLAY but failed for some
      * tables
       78  SQL-RC-W2451              VALUE    2451.
      * failed to complete INIT,COPY, REPLAY for any tables
       78  SQL-RC-E2452              VALUE    -2452.
      * failed to write to the output file
       78  SQL-RC-E2454              VALUE    -2454.
      * db cfg param has been set to <value>. Other params have also been
      * set to <value>
       78  SQL-RC-I2456              VALUE    2456.
      * CFMT: CF self tuning memory not enabled
       78  SQL-RC-W2457              VALUE    2457.
      * DB2_DATABASE_CF_MEMORY was changed, databases need reactivation
       78  SQL-RC-W2458              VALUE    2458.
      * CFMT: DB growth might be impacted
       78  SQL-RC-W2460              VALUE    2460.
      * CFMT: Could not be enabled because v10.5 FP5 was not committed
       78  SQL-RC-W2461              VALUE    2461.
      * Cannot update CF structure param while a resize is in progress
       78  SQL-RC-E2756              VALUE    -2756.

      * Error SQLCODEs for the ingest utility

      * The use of modifier "modifier" is not consistent across all fields
      * of type "<field-type>". 
       78  SQL-RC-E2910              VALUE    -2910.
      * Binary field types can be specified only when the format is
      * POSITIONAL.
       78  SQL-RC-E2911              VALUE    -2911.
      * An INGEST command must specify the RECORDLEN parameter if any field
      * types are binary.
       78  SQL-RC-E2912              VALUE    -2912.
      * Field "<field-name>" does not specify the end position or the
      * length.
       78  SQL-RC-E2913              VALUE    -2913.
      * The sum of all the field lengths is "<number>", but the specified
      * record length is only "<length>". 
       78  SQL-RC-E2915              VALUE    -2915.
      * The INGEST command specifies an SQL statement that does not
      * reference any fields.
       78  SQL-RC-E2916              VALUE    -2916.
      * The shm_max_size configuration parameter is too small.
       78  SQL-RC-E2917              VALUE    -2917.
      * Invalid combination of keywords, "<keyword1>" and "<keyword2>",
      * specified in the INGEST command.
       78  SQL-RC-E2918              VALUE    -2918.
      * The ingest utility does not support tables of type "type".
       78  SQL-RC-E2919              VALUE    -2919.
      * The "<clause>" clause does not reference any fields.
       78  SQL-RC-E2920              VALUE    -2920.
      * Field "field-name" is not defined.
       78  SQL-RC-E2921              VALUE    -2921.
      * Data type "<data-type>" is not a valid field type.
       78  SQL-RC-E2923              VALUE    -2923.
      * Field "field-name" specifies the DEFAULTIF parameter, but its
      * corresponding column "column-name" is a generated column.
       78  SQL-RC-E2924              VALUE    -2924.
      * Field "field-name" specifies the DEFAULTIF parameter, but its
      * corresponding column "column-name" does not have a default value.
       78  SQL-RC-E2925              VALUE    -2925.
      * Field "field-name" specifies the DEFAULTIF parameter, but its
      * corresponding column "column-name" has a default value that is not
      * constant or NULL.
       78  SQL-RC-E2926              VALUE    -2926.
      * The field value on line "line-number" and field "field-number"
      * cannot be converted to the value type: "value-type".
       78  SQL-RC-E2927              VALUE    -2927.
      * Input source "input-source" is not a named pipe.
       78  SQL-RC-E2928              VALUE    -2928.
      * An error occurred opening, reading, or closing named pipe
      * "pipe-name".
       78  SQL-RC-E2931              VALUE    -2931.
      * The ingest utility failed to allocate an interprocess communication
      * (IPC) resource after "number" attempts. Resource type
      * "resource-type-code".
       78  SQL-RC-E2932              VALUE    -2932.
      * The INGEST command has not received any data within "<seconds>"
      * seconds as required by the configuration parameter "<parameter>".
       78  SQL-RC-E2933              VALUE    -2933.
      * Port number "<port-number>" to which service name "<service-name>"
      * maps is outside the following range of allowable values:
      * "<start-of-range>" to "<end-of-range>".
       78  SQL-RC-E2934              VALUE    -2934.
      * Port number "<port-number>" at host "<host-name>" is already in use.
       78  SQL-RC-E2936              VALUE    -2936.
      * The DEFAULTIF clause on field "<field-name>" specifies a position
      * but the format is not positional.
       78  SQL-RC-E2937              VALUE    -2937.
      * The beginning-ending location pair "<begin>", "<end>" for field
      * "<field-name>" is not valid.
       78  SQL-RC-E2938              VALUE    -2938.
      * The value "<value>" for command parameter "<parameter>" is outside
      * the following range of allowable values: "<start-of-range>" to
      * "<end-of-range>".
       78  SQL-RC-E2939              VALUE    -2939.
      * The ingest utility does not support DB2 server versions earlier than
      * version "<version>".
       78  SQL-RC-E2940              VALUE    -2940.
      * The length, precision, or scale "<value>" for field "<field-name>"
      * is not valid.
       78  SQL-RC-E2941              VALUE    -2941.
      * Field "<field-name>" specifies the DEFAULTIF clause, but is
      * associated with multiple columns or used in an expression.
       78  SQL-RC-E2942              VALUE    -2942.
      * The ingest utility cannot update the table because all updated
      * columns in the SQL statement are defined as GENERATED ALWAYS.
       78  SQL-RC-E2943              VALUE    -2943.
      * The number of fields is not the same as the number of specified or
      * implied table columns.
       78  SQL-RC-E2944              VALUE    -2944.
      * Fields of type DB2SECURITYLABEL must specify NAME or STRING for
      * delimited files.
       78  SQL-RC-E2945              VALUE    -2945.
      * The INGEST command must include the field list for this file format.
       78  SQL-RC-E2946              VALUE    -2946.
      * Ingest job with identifier "<job-id>" not found.
       78  SQL-RC-E2947              VALUE    -2947.
      * The INGEST command does not support the data type "<data-type>" used
      * in column "<column-name>".
       78  SQL-RC-E2948              VALUE    -2948.
      * The value assigned to a column or used in a predicate is too long or
      * out of range.
       78  SQL-RC-E2949              VALUE    -2949.
      * The base tables of view "<view-name>" are protected by more than one
      * security policy.
       78  SQL-RC-E2950              VALUE    -2950.
      * The security policy "<security-policy>" was not found.
       78  SQL-RC-E2951              VALUE    -2951.
      * Code page "<code-page>" is not a valid code page, not compatible
      * with the client code page, or not supported by the INGEST command.
       78  SQL-RC-E2952              VALUE    -2952.
      * The field value in line "<line-number>" starting at byte position
      * "<number>" cannot be converted to the value type: "<field-type>".
       78  SQL-RC-E2953              VALUE    -2953.
      * The INGEST command can specify at most "<number>" field definitions.
       78  SQL-RC-E2954              VALUE    -2954.
      * The ingest utility could not find file "<filename>".
       78  SQL-RC-E2955              VALUE    -2955.
      * The ingest operation failed because invalid input was specified.
      * Structure: "<structure-name>". Field: "<field-name>". Value:
      * "<value>".
       78  SQL-RC-E2956              VALUE    -2956.
      * The ingest utility could not find the restart log table
      * "<table-name>".
       78  SQL-RC-E2957              VALUE    -2957.
      * The INGEST command cannot restart because one of the following does
      * not match the original INGEST command: the number of input sources,
      * or the setting of NUM_FLUSHERS_PER_PARTITION. Original number of
      * input sources: "<number-of-input-sources>".  Original value of
      * NUM_FLUSHERS_PER_PARTITION: "<number-of-flushers>".  Current number
      * of input sources: "<number-of-input-sources>".  Current value of
      * NUM_FLUSHERS_PER_PARTITION: "<number-of-flushers>".
       78  SQL-RC-E2958              VALUE    -2958.
      * Row "<row-number>" contains an invalid security label string for the
      * target table.
       78  SQL-RC-E2960              VALUE    -2960.
      * The INGEST command can specify at most "<number>" input file names
      * or pipe names.
       78  SQL-RC-E2961              VALUE    -2961.
      * When restart is on, the nickname specified on the INGEST command
      * must have server option DB2_TWO_PHASE_COMMIT set to 'Y'.
       78  SQL-RC-E2962              VALUE    -2962.
      * The INGEST command cannot restart because the ingest job "<job-ID>"
      * is still active.
       78  SQL-RC-E2964              VALUE    -2964.
      * A non-numeric field value is used where a numeric value is expected.
       78  SQL-RC-E2968              VALUE    -2968.
      * A field that maps to a distribution key column contains a value that
      * is invalid or out of range for the column type. The utility cannot
      * pre-partition the input record. Field value: "<field-value>". Column
      * type: "<column-type>". Column length: "<number>".
       78  SQL-RC-E2969              VALUE    -2969.
      * Database "<db-name>" uses node <"<node-name>", but the utility
      * cannot find the node in the node directory.
       78  SQL-RC-E2970              VALUE    -2970.
      * The ingest operation failed because invalid input was specified.
      * Outer structure: "<outer-structure-name>". Inner structure:
      * "<inner-structure-name>". Index: "<index- number>". Field:
      * "<field-name>". Value: "<value>". 
       78  SQL-RC-E2971              VALUE    -2971.
      * The INGEST command cannot restart because one or more command
      * parameters or the input data is inconsistent with the original
      * command.
       78  SQL-RC-E2972              VALUE    -2972.
      * Field "<field-name>" of type "<field-type>" specifies an invalid
      * format string "<format-string>".
       78  SQL-RC-E2973              VALUE    -2973.
      * The INGEST command cannot continue because the primary database
      * connection has been lost.
       78  SQL-RC-E2974              VALUE    -2974.
      * When the INGEST command is restartable, the RECONNECT_COUNT ingest
      * configuration parameter must be set to 0.
       78  SQL-RC-E2975              VALUE    -2975.
      * An error occurred calling a system function or system command. 
      * Function or command: "<function-or-command-name>".  Reason code:
      * "<reason-code>".  Additional tokens: "<additional-tokens>".
       78  SQL-RC-E2981              VALUE    -2981.

      * Error SQLCODEs for the IMPORT and LOAD utilities

      * An I/O error occurred while opening the message file.
       78  SQL-RC-E3006              VALUE    -3006.
      * A delimiter is not valid or is used more than once.
       78  SQL-RC-E3017              VALUE    -3017.
      ...
      * The utility has encountered "number" warnings which exceeds the
      * total number of warnings allowed.
       78  SQL-RC-E3502              VALUE    -3502.
      ...
      * The bind, rebind, alter or precompile option or option value
      * "<option-name>" is invalid
       78  SQL-RC-E4930              VALUE    -4930.

      * System error
       78  SQL-RC-E5005              VALUE    -5005.
      * Host variable is not exact numeric type
       78  SQL-RC-E5012              VALUE    -5012.
      * Client level not supported by this server
       78  SQL-RC-E5048              VALUE    -5048.
      * Invalid qualifier specified in CREATE SCHEMA
       78  SQL-RC-E5051              VALUE    -5051.
      * The query failed because the data in HDFS cannot be mapped to the
      * Hadoop table definition.
       78  SQL-RC-E5104              VALUE    -5104.
      * The statement failed because a Hadoop component encountered an
      * error.
       78  SQL-RC-E5105              VALUE    -5105.
      * The statement failed because of a mismatch between meta data in the
      * Hive metastore and the Hadoop table definition in the Big SQL
      * catalog.
       78  SQL-RC-E5106              VALUE    -5106.
      * A configuration file contains an invalid value for a property.
       78  SQL-RC-E5107              VALUE    -5107.
      * The LOAD HADOOP statement was aborted and no data was loaded into
      * the target table because the number of rejected source records
      * exceeded the limit.
       78  SQL-RC-E5109              VALUE    -5109.
      * The LOAD HADOOP statement was not processed because the load utility
      * was unable to determine which column to use for splitting the source
      * data.
       78  SQL-RC-E5110              VALUE    -5110.
      * The LOAD HADOOP statement failed because of an error with a
      * component.
       78  SQL-RC-E5111              VALUE    -5111.
      * The LOAD HADOOP statement was not processed because the specified
      * source URL is invalid.
       78  SQL-RC-E5114              VALUE    -5114.
      * The Command/Statement/function is not supported in the BigSql
      * Environment.
       78  SQL-RC-E5115              VALUE    -5115.
      * Datalake infrastructure failed to start.
       78  SQL-RC-E5116              VALUE    -5116.
      * Datalake infrastructure failed to shutdown.
       78  SQL-RC-E5117              VALUE    -5117.
      * Datalake feature for this datalake database disabled,because the
      * instance does not support more than one active Datalake database.
       78  SQL-RC-W5118              VALUE    5118.
      * The Datalake feature for this database is disabled because the
      * instance does not support Datalake database.
       78  SQL-RC-W5119              VALUE    5119.
      * Updates to global parameters cannot use the MEMBER clause.
       78  SQL-RC-E5125              VALUE    -5125.
      * Cannot alter an AWE bufferpool to automatic
       78  SQL-RC-E5143              VALUE    -5143.
      * configuration parameter values same
       78  SQL-RC-E5162              VALUE    -5162.
      * configuration parameter missing
       78  SQL-RC-E5163              VALUE    -5163.
      * configuration group contains no parameters
       78  SQL-RC-E5164              VALUE    -5164.
      * Insufficient CF memory to accomodate allocation request during
      * activation
       78  SQL-RC-E5157              VALUE    -5157.
      ...
      * Configuring the Db2 environment failed because the specified Db2
      * environment variable, Db2 registry variable, Db2 configuration
      * parameter, command option, or value of one of the preceding items is
      * discontinued. Variable, parameter, option name, or value:
      * <variable-or-parameter-name>
       78  SQL-RC-E5186              VALUE    -5186.
      * The statement failed because <object name> of type
      * <access-control-type> is marked invalid.
       78  SQL-RC-E5188              VALUE    -5188.

      * Operation not allowed for connect procedure
       78  SQL-RC-E5187              VALUE    -5187.
      * The specified alternate diagnostic directory path is invalid
       78  SQL-RC-E5189              VALUE    -5189.
      * The driver connection failed because the client is unable to obtain
      * a connection to InfoSphere Optim Configuration Manager.
       78  SQL-RC-E5194              VALUE    -5194.

      * Operation is ignored for ADMIN_SET_INTRA_PARALLEL
       78  SQL-RC-W5192              VALUE    5192.
      * No usage privilege on any enabled workloads
       78  SQL-RC-E5193              VALUE    -5193.

      * The statement failed because of a communication error with a Big SQL
      * component. Big SQL component name: <component-name>.  Reason code:
      * <reason-code>. Log entry identifier: <log-entry-identifier>.
       78  SQL-RC-E5197              VALUE    -5197.

      * The statement failed because of an authorization error from a Big
      * SQL component. Big SQL component name: <component-name>.  Reason
      * code: <reason-code>. Log entry identifier: <log-entry-identifier>.
       78  SQL-RC-E5198              VALUE    -5198.

      * The statement failed because the database manager was unable to
      * allocate enough shared memory from the FMP memory set to communicate
      * with the Hadoop component I/O library.
       78  SQL-RC-E5199              VALUE    -5199.
      ...
      * The number of partitioning keys defined in the data file header
      * ("number-1") does not match the number of partitioning keys defined
      * for the table ("number-2").
       78  SQL-RC-E6108              VALUE    -6108.
      * The program failed to extract partitioning key information for table
      * table-name from the system catalog table.
       78  SQL-RC-E6506              VALUE    -6506.
      ...
      * Conflicting License Certificates
       78  SQL-RC-E8005              VALUE    -8005.
      ...
      * valid license key was not found for the requested function
       78  SQL-RC-E8029              VALUE    -8029.

      * Page number too high
       78  SQL-RC-E8100              VALUE    -8100.
      * Segment in error
       78  SQL-RC-E8101              VALUE    -8101.
      * The "name" is too longe.  The maximum length is "max-length".
       78  SQL-RC-E9305              VALUE    -9305.
      ...
      * request to decompose x documents was successfull for y documents
       78  SQL-RC-W16278             VALUE    16278.
      * XSLT parsing or validation error
       78  SQL-RC-E16280             VALUE    -16280.

      * JSON data is not valid
       78  SQL-RC-E16402             VALUE    -16402.
      * Result contains no SQL/JSON item
       78  SQL-RC-E16405             VALUE    -16405.
      * JSON data has non-unique keys
       78  SQL-RC-E16406             VALUE    -16406.
      * JSON object has non-unique keys
       78  SQL-RC-E16407             VALUE    -16407.
      * SQL/JSON member not found
       78  SQL-RC-E16410             VALUE    -16410.
      * SQL/JSON scalar required
       78  SQL-RC-E16413             VALUE    -16413.

      * internal object limit exceeded
       78  SQL-RC-E20005             VALUE    -20005.
      * An internal error occurred
       78  SQL-RC-E16500             VALUE    -16500.
      * Spatial Analyticscould not access its memory pool
       78  SQL-RC-E16501             VALUE    -16501.
      * Spatial Analytics could not allocate number bytes of memory
       78  SQL-RC-E16502             VALUE    -16502.
      * An internal parameter error occurred
       78  SQL-RC-E16503             VALUE    -16503.
      * Register failed because the spatial column is already registered
       78  SQL-RC-E16504             VALUE    -16504.
      * The spatail column is not registered
       78  SQL-RC-E16505             VALUE    -16505.
      * Invalid SRS identifier
       78  SQL-RC-E16506             VALUE    -16506.
      * Null unit name
       78  SQL-RC-E16507             VALUE    -16507.
      * No unit
       78  SQL-RC-E16508             VALUE    -16508.
      * Unsupported conversion to unit
       78  SQL-RC-E16509             VALUE    -16509.
      * No unit in SRS
       78  SQL-RC-E16510             VALUE    -16510.
      * Unknown internal type id
       78  SQL-RC-E16511             VALUE    -16511.
      * Invalid part number
       78  SQL-RC-W16512             VALUE    16512.
      * Invalid ring number
       78  SQL-RC-W16513             VALUE    16513.
      * Invalid point number
       78  SQL-RC-W16514             VALUE    16514.
      * Invalid DE9-IM matrix
       78  SQL-RC-E16515             VALUE    -16515.
      * Transformation to SRS failed
       78  SQL-RC-E16516             VALUE    -16516.
      * Unsupported cast
       78  SQL-RC-E16517             VALUE    -16517.
      * Geometry not converted to ST_Linestring; not MultiPoint geometry
       78  SQL-RC-E16518             VALUE    -16518.
      * Unable to register a non-spatial column.
       78  SQL-RC-E16519             VALUE    -16519.
      * Geometry not created from KML document; document error 
       78  SQL-RC-E16520             VALUE    -16520.
      * Representation too short
       78  SQL-RC-E16521             VALUE    -16521.
      * Internal geometry too short
       78  SQL-RC-E16522             VALUE    -16522.
      * Geometry inconsistent
       78  SQL-RC-E16523             VALUE    -16523.
      * Point is empty
       78  SQL-RC-E16524             VALUE    -16524.
      * Inconsistent coordinates
       78  SQL-RC-E16525             VALUE    -16525.
      * Invalid byte order
       78  SQL-RC-E16526             VALUE    -16526.
      * Invalid number of points
       78  SQL-RC-E16527             VALUE    -16527.
      * Invalid extent in geometry
       78  SQL-RC-E16528             VALUE    -16528.
      * Invalid text data
       78  SQL-RC-E16529             VALUE    -16529.
      * Invalid GML; expecting char instead of string
       78  SQL-RC-E16530             VALUE    -16530.
      * Invalid GML; expecting different tag
       78  SQL-RC-E16531             VALUE    -16531.
      * Invalid GML; expecting number instead of text
       78  SQL-RC-E16532             VALUE    -16532.
      * Invalid GML type
       78  SQL-RC-E16533             VALUE    -16533.
      * GML point has been incorrectly specified
       78  SQL-RC-E16534             VALUE    -16534.
      * Invalid part offset in shape
       78  SQL-RC-E16535             VALUE    -16535.
      * Invalid type ID type-idin shape
       78  SQL-RC-E16536             VALUE    -16536.
      * Invalid length of shape encoding
       78  SQL-RC-E16537             VALUE    -16537.
      * Invalid WKT format char
       78  SQL-RC-E16538             VALUE    -16538.
      * Invalid WKT format number
       78  SQL-RC-E16539             VALUE    -16539.
      * Unexpected parenthesis in WKT
       78  SQL-RC-E16540             VALUE    -16540.
      * Parenthesis mismatch in WKT
       78  SQL-RC-E16541             VALUE    -16541.
      * Unknown type in WKT
       78  SQL-RC-E16542             VALUE    -16542.
      * Invalid type id in WKB
       78  SQL-RC-E16543             VALUE    -16543.
      * Unknown error
       78  SQL-RC-E16544             VALUE    -16544.
      * Insufficient memory
       78  SQL-RC-E16545             VALUE    -16545.
      * Invalid geometry type
       78  SQL-RC-E16546             VALUE    -16546.
      * Too many parts specified
       78  SQL-RC-E16547             VALUE    -16547.
      * Incorrect geometry type
       78  SQL-RC-E16548             VALUE    -16548.
      * Text is too long
       78  SQL-RC-E16549             VALUE    -16549.
      * Invalid parameter value
       78  SQL-RC-E16550             VALUE    -16550.
      * Invalid geometry produced
       78  SQL-RC-E16551             VALUE    -16551.
      * Incompatible geometries
       78  SQL-RC-E16552             VALUE    -16552.
      * Invalid geometry
       78  SQL-RC-E16553             VALUE    -16553.
      * Too many points
       78  SQL-RC-E16554             VALUE    -16554.
      * Geometry too small
       78  SQL-RC-E16555             VALUE    -16555.
      * Buffer out of bounds
       78  SQL-RC-E16556             VALUE    -16556.
      * Invalid scale factor
       78  SQL-RC-E16557             VALUE    -16557.
      * Coordinate out of bounds
       78  SQL-RC-E16558             VALUE    -16558.
      * Invalid coordinate systemdefinition
       78  SQL-RC-E16559             VALUE    -16559.
      * Projection error
       78  SQL-RC-E16560             VALUE    -16560.
      * Polygon rings overlap
       78  SQL-RC-E16561             VALUE    -16561.
      * Too few points
       78  SQL-RC-E16562             VALUE    -16562.
      * Polygon is not closed
       78  SQL-RC-E16563             VALUE    -16563.
      * Invalid exterior ring
       78  SQL-RC-E16564             VALUE    -16564.
      * Polygon has no area
       78  SQL-RC-E16565             VALUE    -16565.
      * Exterior rings overlap
       78  SQL-RC-E16566             VALUE    -16566.
      * Polygon intersects itself
       78  SQL-RC-E16567             VALUE    -16567.
      * Invalid number of parts
       78  SQL-RC-E16568             VALUE    -16568.
      * Incompatible spatial reference systems
       78  SQL-RC-E16569             VALUE    -16569.
      * BLOB too small
       78  SQL-RC-E16570             VALUE    -16570.
      * Invalid geometry type
       78  SQL-RC-E16571             VALUE    -16571.
      * Invalid byte order
       78  SQL-RC-E16572             VALUE    -16572.
      * Empty geometry
       78  SQL-RC-E16573             VALUE    -16573.
      * Invalid end point
       78  SQL-RC-E16574             VALUE    -16574.
      * Point not found
       78  SQL-RC-E16575             VALUE    -16575.
      * Drop failed; column is registered to SRS
       78  SQL-RC-E16577             VALUE    -16577.
      * Spatial column could not be registered
       78  SQL-RC-E16578             VALUE    -16578.
      * Parameters corrected automatically
       78  SQL-RC-W16579             VALUE    16579.
      * Duplicate srs name
       78  SQL-RC-E16580             VALUE    -16580.
      * Duplicate srs id
       78  SQL-RC-E16581             VALUE    -16581.
      ...
      * LIKE clause not valid on GTTs with hidden columns
       78  SQL-RC-E20092             VALUE    -20092.
      ...
      * column cannot be altered as specified
       78  SQL-RC-E20180             VALUE    -20180.
      ...
      * The package must be rebound to be successfully executed.
       78  SQL-RC-E20249             VALUE    -20249.
      ...
      * There are no storage groups defined
       78  SQL-RC-E20317             VALUE    -20317.
      * Alter tablespace operation not allowed for this type of table space
      ...
      * The table cannot be truncated because DELETE triggers exist for the
      * table, or the table is the parent in a referential constraint
       78  SQL-RC-E20356             VALUE    -20356.
      ...
      * Update operation with all columns unassigned
       78  SQL-RC-E20434             VALUE    -20434.
      * Multiple ARRAY_AGGs with different sort-keys
       78  SQL-RC-E20435             VALUE    -20435.
      * Invalid array element or index type
      ...
      * Revoke SECADM authority from <authorization-id> was denied
       78  SQL-RC-E20464             VALUE    -20464.
      * The binary XML value is incomplete or contains unrecognized data
       78  SQL-RC-E20465             VALUE    -20465.
      * Expression following the <keywords> clause cannot be computed as a
      * single value for the query
       78  SQL-RC-E20467             VALUE    -20467.
      * Row or column access control activation for table <table-name> has
      * failed due to reason code <reason-code>
       78  SQL-RC-E20469             VALUE    -20469.
      * The CREATE or ALTER statement failed because <object-type1>
      * <object-name1> was not defined as secure and <object-type2>
      * <object-name2> is dependent on it
       78  SQL-RC-E20470             VALUE    -20470.
      * The INSERT or UPDATE statement failed because a resulting row did
      * not satisfy row permissions
       78  SQL-RC-E20471             VALUE    -20471.
      * The ALTER statement on the permission or mask <object-name> failed
      * due to reason code <reason-code>
       78  SQL-RC-E20472             VALUE    -20472.
      * The function <function-name>, created with the NOT SECURE option
      * failed. The function referenced column <column-name> which has a
      * column mask with column access control activated for the table
       78  SQL-RC-E20473             VALUE    -20473.
      * The CREATE PERMISSION or CREATE MASK statement failed on the
      * database object <object-name> of object type <object-type> due to
      * reason code <reason-code>
       78  SQL-RC-E20474             VALUE    -20474.
      * The CREATE MASK statement failed because a column mask is already
      * defined for the specified column. Column name: <column-name>. Table
      * name: <table-name>. Existing mask name: <mask-name>
       78  SQL-RC-E20475             VALUE    -20475.
      * Function invoked with invalid format string
       78  SQL-RC-E20476             VALUE    -20476.
      * Not able to use format string to interpret input string
       78  SQL-RC-E20477             VALUE    -20477.
      * The statement failed because the column mask <mask-name> defined for
      * column <column-name> exists and the column mask cannot be applied or
      * the column mask conflicts with the failed statement. Reason code
      * <reason-code>
       78  SQL-RC-E20478             VALUE    -20478.
      * The ALTER or RENAME statement failed on the table <table-name>
      * because the table is part of row or column access control
      * definitions. Reason code <reason-code>
       78  SQL-RC-E20479             VALUE    -20479.
      * Invalid use of a named parameter when invoking a routine
       78  SQL-RC-E20483             VALUE    -20483.
      * The invocation of the routine omits a paremeter which is not defined
      * with a DEFAULT
       78  SQL-RC-E20484             VALUE    -20484.
      * Parameter definition for the routine includes an option that is
      * invalid
       78  SQL-RC-E20485             VALUE    -20485.
      * Table does not have system period
       78  SQL-RC-E20490             VALUE    -20490.
      * Invalid specification of period
       78  SQL-RC-E20491             VALUE    -20491.
      * Public alias must have SYSPUBLIC as schema
       78  SQL-RC-E20494             VALUE    -20494.
      * The definition of the module initialization procedure SYS_INIT is
      * not valid
       78  SQL-RC-E20495             VALUE    -20495.
      * Routines without implementation cannot be invoked
       78  SQL-RC-E20496             VALUE    -20496.
      * Row data type has a field type which is not supported
       78  SQL-RC-E20498             VALUE    -20498.
      * Type is not valid for the operand of a predicate
       78  SQL-RC-E20499             VALUE    -20499.
      * Invalid use of a row data type in a list of values
       78  SQL-RC-E20500             VALUE    -20500.
      * The explain facility failed because the specified section could not
      * be found
       78  SQL-RC-E20501             VALUE    -20501.
      * The explain facility failed because the specified event monitor is
      * not a write to table event monitor.
       78  SQL-RC-E20502             VALUE    -20502.
      * The explain facility is not supported for the specified section.
       78  SQL-RC-E20503             VALUE    -20503.
      * The target object of the anchored data type is not supported
       78  SQL-RC-E20504             VALUE    -20504.
      * The WITH ORDINALITY clause is not valid with UNNEST of an
      * associative array
       78  SQL-RC-E20505             VALUE    -20505.
      * A cursor variable cannot be opened because it references a variable
      * that is not valid in the current scope.
       78  SQL-RC-E20506             VALUE    -20506.
      * A cursor variable operation would recursively invoke a cursor
      * operation on the same cursor.
       78  SQL-RC-E20507             VALUE    -20507.
      * Error during explicit revalidation of object
       78  SQL-RC-E20508             VALUE    -20508.
      * A module alias cannot be used as the target of module DDL
       78  SQL-RC-E20509             VALUE    -20509.
      * Not enough available space in the <buffer-name> message buffer
       78  SQL-RC-E20511             VALUE    -20511.
      * No alert has been registered previously with the DBMS_ALERT.REGISTER
      * procedure
       78  SQL-RC-E20512             VALUE    -20512.
      * A UTL_FILE procedure failed to delete or rename a file
       78  SQL-RC-E20513             VALUE    -20513.
      * A UTL_SMTP module routine encountered an SMTP server error
       78  SQL-RC-E20514             VALUE    -20514.
      * A dynamic statement name cannot be used in the cursor value
      * constructor
       78  SQL-RC-E20515             VALUE    -20515.
      * The UTL_SMTP module routine <routine_name> is called out of sequence
       78  SQL-RC-E20518             VALUE    -20518.
      * No data in the local message buffer to unpack
       78  SQL-RC-E20519             VALUE    -20519.
      * Error occurred processing a conditional compilation directive near
      * <string>
       78  SQL-RC-E20521             VALUE    -20521.
      * Invalid specification of WITHOUT OVERLAPS clause
       78  SQL-RC-E20522             VALUE    -20522.
      * Table cannot be used as history table
       78  SQL-RC-E20523             VALUE    -20523.
      * Invalid specification of period clause
       78  SQL-RC-E20524             VALUE    -20524.
      * Period cannot be added to this table
       78  SQL-RC-E20525             VALUE    -20525.
      * The variable <variable-name> is the target of two or more
      * assignments with no defined order of assignment.
       78  SQL-RC-E20526             VALUE    -20526.
      * Period does not exist in this table
       78  SQL-RC-E20527             VALUE    -20527.
      * Another transaction modified this row
       78  SQL-RC-E20528             VALUE    -20528.
      * The version number specified in a binary XML is not supported.
       78  SQL-RC-E20531             VALUE    -20531.
      * The argument to the WRAP function or to the CREATE_WRAPPED procedure
      * is not valid
       78  SQL-RC-E20529             VALUE    -20529.
      * An obfuscated statement is not valid. Reason code=<rc>
       78  SQL-RC-E20530             VALUE    -20530.
      * The command or API function call failed because the command or API
      * function is discontinued.
       78  SQL-RC-E20532             VALUE    -20532.
      * date type not supported in typed-correlation clause when referencing
      * a generic table UDF
       78  SQL-RC-E20533             VALUE    -20533.
      * Data cannot be updated  when a temporal special register is set
       78  SQL-RC-E20535             VALUE    -20535.
      * The operation cannot be processed because it involves a text index
       78  SQL-RC-E20536             VALUE    -20536.
      * The query failed because a negative or the null value is used in the
      * clause keywords
       78  SQL-RC-E20539             VALUE    -20539.
      * An autonomous transaction executing a procedure has been terminated
      * abnormally
       78  SQL-RC-E20540             VALUE    -20540.
      * Unexpected error code <string> received from in-database analytics
      * provider <string>. Associated text and tokens: <string>.
       78  SQL-RC-E20541             VALUE    -20541.
      * The statement was not executed because the maximum number of client
      * reroute seamless failover attempts has been exceeded
       78  SQL-RC-E20542             VALUE    -20542.
      * The statement failed because an error was encountered while the
      * ANALYZE_TABLE expression was being processed.
       78  SQL-RC-E20544             VALUE    -20544.
      * The statement failed because communication with the in-database
      * analytics provider could not be established or maintained.
       78  SQL-RC-E20545             VALUE    -20545.
      * ANALYZE_TABLE expression is not supported in the context where it is
      * specified.
       78  SQL-RC-E20546             VALUE    -20546.
      * The statement failed because the target of an assignment is a
      * read-only global variable
       78  SQL-RC-E20547             VALUE    -20547.
      * The statement failed because a column of the input table of an
      * ANALYZE_TABLE expression has an unsupported data type.
       78  SQL-RC-E20548             VALUE    -20548.
      * Constructing an associative array failed because the input data
      * includes at least one duplicate array index value.
       78  SQL-RC-E20551             VALUE    -20551.
      * Value is not allowed because it does not conform to the data type
      * constraint of user-defined type <type-name>. Value is <value>.
       78  SQL-RC-E20552             VALUE    -20552.
      * The statement failed because of an error in the Hive metastore. Log
      * entry identifier: log-entry-identifier.
       78  SQL-RC-E20557             VALUE    -20557.
      * The statement failed because the regular expression string is not
      * valid. Reason code: <reason-code>.  Function name: <function name>.
      * Position in regular expression string: <position>. Regular
      * expression string: <string>.
       78  SQL-RC-E20558             VALUE    -20558.
      * The analytics operation succeeded with a warning.
       78  SQL-RC-W20559             VALUE    20559.
      * The routine did not run because the formatting or content of the
      * specified string argument is invalid.
       78  SQL-RC-E20560             VALUE    -20560.
      * The analytics operation could not be performed because of a problem
      * with a table.
       78  SQL-RC-E20561             VALUE    -20561.
      * The analytics operation could not be performed because the specified
      * options are not valid.
       78  SQL-RC-E20562             VALUE    -20562.
      * The analytics operation failed. 
       78  SQL-RC-E20563             VALUE    -20563.
      * The analytics operation failed because of an authorization problem. 
       78  SQL-RC-E20564             VALUE    -20564.
      * The identified component routine when creating an aggregate
      * interface function is not valid. 
       78  SQL-RC-E20566             VALUE    -20566.
      * The external table operation failed because of a problem with the
      * data file. 
       78  SQL-RC-E20569             VALUE    -20569.
      * The statement failed because the number of rejected rows exceeds the
      * limit set in the MaxErrors option value. 
       78  SQL-RC-E20570             VALUE    -20570.
      * A view cannot be defined on a transient external table 
       78  SQL-RC-E20586             VALUE    -20586.
      ...
      * The creation or revalidation of an object would result in an invalid
      * cyclic self-reference
       78  SQL-RC-E20481             VALUE    -20481.
      * Revalidation failed for all objects
       78  SQL-RC-E20482             VALUE    -20482.
      ...
      * Internal parameter processing error
       78  SQL-RC-W20458             VALUE    20458.
      * Internal processing error
       78  SQL-RC-W20459             VALUE    20459.
      * Procedure supports higher version
       78  SQL-RC-W20460             VALUE    20460.
      * Procedure returned the output in alternate locale
       78  SQL-RC-W20461             VALUE    20461.
      * Specified locale is not supported
       78  SQL-RC-W20384             VALUE    20384.
      * Procedure does not support version of the parameter
       78  SQL-RC-E20457             VALUE    -20457.
      * Multiple result values cannot be returned from a scalar function
       78  SQL-RC-E20556             VALUE    -20556.
      * Operation not allowed on object because schema is not accessible
       78  SQL-RC-E20573             VALUE    -20573.
      * The update completed successfully. The OPT_SORTHEAP parameter has
      * been reset to 0.
       78  SQL-RC-W20574             VALUE    20574.
      * A statement conflicts with another statement in the same unit of
      * work
       78  SQL-RC-E20575             VALUE    -20575.
      * TLS connection error
       78  SQL-RC-E20576             VALUE    -20576.
      * CREATE/ALTER TRUSTED CONTEXT statement failed because the procedure
      * specified for the TRUST PROCEDURE attribute, <procedure-name>, is
      * not valid due to reason code <reason-code>.
       78  SQL-RC-E20582             VALUE    -20582.
      * The ADD EXCEPTION statement tried to add an audit exception on
      * object "<name>" of type "<type>" when an audit exception for name
      * "<name2>" of type "<type2>" already exists on the application server
      * or in the same statement.
       78  SQL-RC-E20583             VALUE    -20583.
      * The audit exception on object "<name>" of type "<type>" for object
      * "<name2>" of type "<type2>" is not defined in the database. 
       78  SQL-RC-E20584             VALUE    -20584.
      * The procedure "<procedure-name>" is being used by a trusted
      * connection. "<operation-type>" operation is not allowed.
       78  SQL-RC-E20585             VALUE    -20585.
      * A model operation could not be completed on the provided object
       78  SQL-RC-E20587             VALUE    -20587.

      * Replication-maintained MQT PK doesn't correspond to base table PK/UK
       78  SQL-RC-E1742              VALUE    -1742.
      * A user-defined function has encountered a deadlock with a CPad
       78  SQL-RC-E1748              VALUE    -1748.
      * Error in create function ENVIRONMENT clause
       78  SQL-RC-E1747              VALUE    -1747.
      * Table or view "<schema-name>"."<name>" already exists.
       78  SQL-RC-W4136              VALUE    4136.
      * WAITFORDATA SQLCODES

      * Failed to wait for incremental updates. Reason: "reason"
       78  SQL-RC-E20581             VALUE    -20581.
      * The database is UCA collated, so the created "object-type" might be
      * impacted by ICU refresh.
       78  SQL-RC-W20589             VALUE    20589.
      * Altering the column "<column-name>" of column-organized table
      * "<table-name>" is not allowed. Reason code: "<reason-code>"
       78  SQL-RC-E20591             VALUE    -20591.
      * The statement was not processed because an AI API from provider
      * "<provider-name>" returned an error: "<error-msg>". Please see
      * db2diag.log for more details.
       78  SQL-RC-E20592             VALUE    -20592.
      * The statement was not processed because connection to AI API with
      * provider "<provider-name>" was unsuccessful.
       78  SQL-RC-E20593             VALUE    -20593.
