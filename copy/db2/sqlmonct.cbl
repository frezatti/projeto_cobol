      ...
      *****************************************************************************
       ...
       78 SQLM-DBMON-VERSION9 VALUE 8.

       78 SQLM-DBMON-VERSION9-5 VALUE 9.

       78 SQLM-CURRENT-VERSION VALUE 9.
      ...
      * Database Manager snapshot *
       78 SQLMA-DB2 VALUE 65537.


      * List of connections *
       78 SQLMA-DBASE-APPLINFO VALUE 65543.

       78 SQLMA-APPLINFO-ALL VALUE 65547.

       78 SQLMA-DCS-APPLINFO-ALL VALUE 65548.


      * Database snapshot *
       78 SQLMA-DBASE VALUE 65538.

       78 SQLMA-DBASE-ALL VALUE 65545.

       78 SQLMA-DCS-DBASE VALUE 65570.

       78 SQLMA-DCS-DBASE-ALL VALUE 65571.

       78 SQLMA-DBASE-REMOTE VALUE 65573.

       78 SQLMA-DBASE-REMOTE-ALL VALUE 65574.


      * Application snapshot *
       78 SQLMA-APPL-ALL VALUE 65546.

       78 SQLMA-APPL VALUE 65539.

       78 SQLMA-AGENT-ID VALUE 65540.

       78 SQLMA-DBASE-APPLS VALUE 65542.

       78 SQLMA-DCS-APPL-ALL VALUE 65566.

       78 SQLMA-DCS-APPL VALUE 65567.

       78 SQLMA-DCS-APPL-HANDLE VALUE 65568.

       78 SQLMA-DCS-DBASE-APPLS VALUE 65569.

       78 SQLMA-DBASE-APPLS-REMOTE VALUE 65575.

       78 SQLMA-APPL-REMOTE-ALL VALUE 65576.


      * Table snapshot *
       78 SQLMA-DBASE-TABLES VALUE 65541.


      * Tablespace snapshot *
       78 SQLMA-DBASE-TABLESPACES VALUE 65549.


      * Snapshot for locks *
       78 SQLMA-APPL-LOCKS VALUE 65556.

       78 SQLMA-APPL-LOCKS-AGENT-ID VALUE 65557.

       78 SQLMA-DBASE-LOCKS VALUE 65544.


      * Bufferpool snapshot *
       78 SQLMA-DBASE-BUFFERPOOLS VALUE 65558.

       78 SQLMA-BUFFERPOOLS-ALL VALUE 65559.


      * Dynamic sql snapshot *
       78 SQLMA-DYNAMIC-SQL VALUE 65572.
      ...
      *****************************************************************************
       ...
       78 SQLM-APPLID-SZ VALUE 64.

       78 SQLM-APPLID-SZ-V8 VALUE 32.

       78 SQLM-SEQ-SZ VALUE 5.

       78 SQLM-SEQ-SZ-V8 VALUE 4.
       ...
       78 SQLM-OLD-PACKAGE-NAME-SZ VALUE 20.
      ...
      * non-SQL operations *
       ...
       78 SQLM-GETNEXTCHUNK VALUE 26.

       78 SQLM-DRPPKG VALUE 27.
      ...
      *****************************************************************************
       ...
       78 SQLM-TABLESPACE-CONTENT-LARGE VALUE 1.
      ...
      *****************************************************************************
       ...
       78 SQLM-REORG-DICT-SAMPLE VALUE 5.
      ...
      *****************************************************************************
       ...
       78 SQLM-HEAP-SORT VALUE 19.

       78 SQLM-HEAP-APPL-SHARED VALUE 20.

       78 SQLM-HEAP-MIN VALUE 1.

       78 SQLM-HEAP-MAX VALUE 20.


      * Memory Pool List ID's (for element SQLM_ELM_POOL_LIST_ID)                  *
       78 SQLM-POOL-LIST-ID-APPLSHR VALUE 0.

       78 SQLM-POOL-LIST-ID-PRIVAGENT VALUE 1.
      ...
      *****************************************************************************
       ...
       78 SQLM-LOCKATTR-WAIT-FOR-AVAIL VALUE 1.

       78 SQLM-LOCKATTR-ESCALATED VALUE 2.

       78 SQLM-LOCKATTR-RR-IN-BLOCK VALUE 4.

       78 SQLM-LOCKATTR-INSERT VALUE 8.

       78 SQLM-LOCKATTR-RR VALUE 16.

       78 SQLM-LOCKATTR-UPDATE-DELETE VALUE 32.

       78 SQLM-LOCKATTR-ALLOW-NEW VALUE 64.

       78 SQLM-LOCKATTR-NEW-REQUEST VALUE 128.

       78 SQLM-LOCKATTR-DELETE-IN-BLOCK VALUE 0.
      ...
      *****************************************************************************
       ...
       78 SQLM-LOCKRELFLAGS-SQLCOMPILER
                            VALUE -2147483648.

       78 SQLM-LOCKRELFLAGS-UNTRACKED VALUE 1073741824.
      ...
      *****************************************************************************
       ...
       78 SQLM-TABLE-PART-LOCK VALUE 20.

       78 SQLM-AUTORESIZE-LOCK VALUE 21.

       78 SQLM-AUTOSTORAGE-LOCK VALUE 22.

       78 SQLM-XML-PATH-LOCK VALUE 23.
      ...
      *****************************************************************************
       ...
       78 SQLM-PROT-TCPIP4 VALUE 9.

       78 SQLM-PROT-TCPIP6 VALUE 10.
       ...
       78 SQLM-PROT-SOCKS4 VALUE 11.

       78 SQLM-PROT-SSL VALUE 12.

       78 SQLM-PROT-SSL4 VALUE 13.

       78 SQLM-PROT-SSL6 VALUE 14.
      ...
      *****************************************************************************
       ...
       78 SQLM-PLATFORM-INSPURKUXI64 VALUE 26.
       ...
       78 SQLM-PLATFORM-SUNX86 VALUE 33.

       78 SQLM-PLATFORM-SUNX8664 VALUE 34.
      ...
      *****************************************************************************
       ...
       78 SQLM-RC-MEMORY-ERROR VALUE -83.
      ...
      * The full name of the monitor element is SQLM_UTILITY_RESTART_RECREATE_INDEX
       ...
       78 SQLM-UTILITY-REDISTRIBUTE VALUE 9.

      * The full name of the monitor element is SQLM_UTILITY_ASYNC_INDEX_CLEANUP
       78 SQLM-UTL-ASYNC-INDEX-CLEANUP VALUE 10.

      * The full name of the monitor element is SQLM_UTILITY_MDC_ROLLOUT_CLEANUP
       78 SQLM-UTL-MDC-ROLLOUT-CLEANUP VALUE 11.
      ...
      *****************************************************************************
       ...
       78 SQLM-WORK-METRIC-TABLES VALUE 6.


      *****************************************************************************
      * Utility states associated with SQLM_ELM_UTILITY_STATE                      *
      *****************************************************************************
       78 SQLM-UTILITY-STATE-EXECUTE VALUE 0.

       78 SQLM-UTILITY-STATE-WAIT VALUE 1.

       78 SQLM-UTILITY-STATE-ERROR VALUE 2.


      *****************************************************************************
      * Utility states associated with SQLM_ELM_UTILITY_INVOKER_TYPE               *
      *****************************************************************************
       78 SQLM-UTILITY-INVOKER-USER VALUE 0.

       78 SQLM-UTILITY-INVOKER-AUTO VALUE 1.


      *****************************************************************************
      * Utility attributes associated with SQLM_ELM_PROGRESS_LIST_ATTR             *
      *****************************************************************************
      * The full name of the monitor element is SQLM_ELM_PROGRESS_LIST_ATTR_SERIAL
       78 SQLM-ELM-PROG-LIST-ATR-SERIAL VALUE 1.

      * The full name of the monitor element is SQLM_ELM_PROGRESS_LIST_ATTR_CONCURRENT
       78 SQLM-ELM-PROG-LIST-ATR-CONCUR VALUE 2.
      ...
      *****************************************************************************
       ...
       78 SQLM-HADR-STATE-DISCONN-PEER VALUE 5.


      *****************************************************************************
      * HADR synchronization mode                                                  *
      *****************************************************************************
       78 SQLM-HADR-SYNCMODE-SYNC VALUE 0.

       78 SQLM-HADR-SYNCMODE-NEARSYNC VALUE 1.

       78 SQLM-HADR-SYNCMODE-ASYNC VALUE 2.
      ...
      * The full name of the monitor element is SQLM_ELM_TABLESPACE_RANGE_CONTAINER
       ...
       78 SQLM-ELM-DB-STO-PATH-INFO VALUE 58.


       78 SQLM-ELM-MEMORY-POOL-LIST VALUE 59.


       78 SQLM-MAX-LOGICAL-ELEMENT VALUE 59.
      ...
      *****************************************************************************
       ...
       78 SQLM-ELM-EVENT-ACTIVITY VALUE 122.

       78 SQLM-ELM-EVENT-ACTIVITYSTMT VALUE 123.

       78 SQLM-ELM-EVENT-ACTIVITYVALS VALUE 124.

       78 SQLM-ELM-EVENT-SCSTATS VALUE 125.

       78 SQLM-ELM-EVENT-WCSTATS VALUE 126.

       78 SQLM-ELM-EVENT-WLSTATS VALUE 127.

       78 SQLM-ELM-EVENT-QSTATS VALUE 128.

       78 SQLM-ELM-EVENT-HISTOGRAMBIN VALUE 129.

      * The full name of the monitor element is SQLM_ELM_EVENT_THRESHOLD_VIOLATIONS
       78 SQLM-ELM-EVENT-THRE-VIOLATIONS VALUE 130.
      ...
      * The full name of the monitor element is SQLM_ELM_ROLLED_BACK_SEQUENCE_NO
       ...
       78 SQLM-ELM-ROWS-RETURNED VALUE 374.
      ...
      * The full name of the monitor element is SQLM_ELM_HASH_JOIN_SMALL_OVERFLOWS
       ...
       78 SQLM-ELM-ROWS-FETCHED VALUE 522.

       78 SQLM-ELM-ROWS-WRITTEN VALUE 523.

       78 SQLM-ELM-ROWS-MODIFIED VALUE 523.
       ...
       78 SQLM-ELM-COORD-PARTITION-NUM VALUE 526.
      ...
      *  New elements for v9.1                                                     *
       78 SQLM-ELM-REORG-LONG-TBSPC-ID VALUE 862.


       78 SQLM-ELM-DATA-PARTITION-ID VALUE 863.

       78 SQLM-ELM-PROGRESS-LIST-ATTR VALUE 864.


      *****************************************************************************
      * New REORG monitoring elements for v9 (Row Compression)                     *
      *****************************************************************************
       78 SQLM-ELM-REORG-ROWSCOMPRESSED VALUE 865.

       78 SQLM-ELM-REORG-ROWSREJECTED VALUE 866.


      *****************************************************************************
      * FCM monitoring element additions for v9                                    *
      *****************************************************************************
       78 SQLM-ELM-CH-FREE VALUE 867.

       78 SQLM-ELM-CH-FREE-BOTTOM VALUE 868.

      *****************************************************************************
      * Utility monitoring element additions for v9                                *
      *****************************************************************************
       78 SQLM-ELM-UTILITY-STATE VALUE 869.

       78 SQLM-ELM-UTILITY-INVOKER-TYPE VALUE 870.

      *****************************************************************************
      * New sort monitor elements                                                  *
      *****************************************************************************

      * The full name of the monitor element is SQLM_ELM_POST_SHRTHRESHOLD_SORTS
       78 SQLM-ELM-POST-SHRTHRESH-SORTS VALUE 871.

      * The full name of the monitor element is SQLM_ELM_POST_SHRTHRESHOLD_HASH_JOINS
       78 SQLM-ELM-POST-SHRTHRESH-HASHJ VALUE 872.

       78 SQLM-ELM-ACTIVE-HASH-JOINS VALUE 873.


       78 SQLM-ELM-POOL-SECONDARY-ID VALUE 874.


       78 SQLM-ELM-FS-ID VALUE 875.

       78 SQLM-ELM-FS-TOTAL-SZ VALUE 876.

       78 SQLM-ELM-FS-USED-SZ VALUE 877.

       78 SQLM-ELM-STO-PATH-FREE-SZ VALUE 878.


       78 SQLM-ELM-POOL-XDA-L-READS VALUE 879.

       78 SQLM-ELM-POOL-XDA-P-READS VALUE 880.

       78 SQLM-ELM-POOL-XDA-WRITES VALUE 881.

       78 SQLM-ELM-POOL-TEMP-XDA-L-READS VALUE 882.

       78 SQLM-ELM-POOL-TEMP-XDA-P-READS VALUE 883.

       78 SQLM-ELM-POOL-ASYNC-XDA-READS VALUE 884.

       78 SQLM-ELM-POOL-ASYNC-XDA-WRITES VALUE 885.

      * The full name of the monitor element is SQLM_ELM_POOL_ASYNC_XDA_READ_REQS
       78 SQLM-ELM-PL-ASYNC-XDA-RD-REQS VALUE 886.

       78 SQLM-ELM-XDA-OBJECT-PAGES VALUE 887.

       78 SQLM-ELM-XQUERY-STMTS VALUE 888.


      *****************************************************************************
      * New Trusted Context monitor element for v9                                 *
      *****************************************************************************
       78 SQLM-ELM-TRUSTED-AUTH-ID VALUE 889.


      ****************************************************************************
      * HADR Peer Window elements                                                 *
      ****************************************************************************
       78 SQLM-ELM-HADR-PEER-WINDOW-END VALUE 890.

       78 SQLM-ELM-HADR-PEER-WINDOW VALUE 891.
      ...
      * The full name of the monitor element is SQLM_ELM_BLOCKS_PENDING_CLEANUP
       78 SQLM-ELM-BLOCKS-PEND-CLEANUP VALUE 892.

       78 SQLM-ELM-AUTHORITY-BITMAP VALUE 893.


       78 SQLM-ELM-TOTAL-OLAP-FUNCS VALUE 894.

      * The full name of the monitor element is SQLM_ELM_POST_THRESHOLD_OLAP_FUNCS
       78 SQLM-ELM-POST-THRE-OLAP-FUNCS VALUE 895.

      * after sortheap threshold    *
      * exceeded                    *
       78 SQLM-ELM-ACTIVE-OLAP-FUNCS VALUE 896.

      * running                     *
       78 SQLM-ELM-OLAP-FUNC-OVERFLOWS VALUE 897.

      * overflowed to temp tables   *

      *****************************************************************************
      * Work Load Management elements for new event monitors                       *
      *****************************************************************************

       78 SQLM-ELM-SERVICE-CLASS-ID VALUE 898.

      * The full name of the monitor element is SQLM_ELM_SERVICE_SUPERCLASS_NAME
       78 SQLM-ELM-SERVICE-SPRCLASS-NAME VALUE 899.

       78 SQLM-ELM-SERVICE-SUBCLASS-NAME VALUE 900.

       78 SQLM-ELM-WORK-ACTION-SET-ID VALUE 901.

       78 SQLM-ELM-WORK-ACTION-SET-NAME VALUE 902.

       78 SQLM-ELM-DB-WORK-ACTION-SET-ID VALUE 903.

       78 SQLM-ELM-SC-WORK-ACTION-SET-ID VALUE 904.

       78 SQLM-ELM-WORK-CLASS-ID VALUE 905.

       78 SQLM-ELM-WORK-CLASS-NAME VALUE 906.

       78 SQLM-ELM-DB-WORK-CLASS-ID VALUE 907.

       78 SQLM-ELM-SC-WORK-CLASS-ID VALUE 908.

       78 SQLM-ELM-WORKLOAD-ID VALUE 909.

      * The full name of the monitor element is SQLM_ELM_WORKLOAD_OCCURRENCE_ID
       78 SQLM-ELM-WL-OCCURRENCE-ID VALUE 910.

       78 SQLM-ELM-WORKLOAD-NAME VALUE 911.

       78 SQLM-ELM-TEMP-TABLESPACE-TOP VALUE 912.

       78 SQLM-ELM-ROWS-RETURNED-TOP VALUE 913.

       78 SQLM-ELM-CONCURRENT-ACT-TOP VALUE 914.

      * The full name of the monitor element is SQLM_ELM_CONCURRENT_CONNECTION_TOP
       78 SQLM-ELM-CONCURR-CONN-TOP VALUE 915.

       78 SQLM-ELM-COST-ESTIMATE-TOP VALUE 916.

       78 SQLM-ELM-STATISTICS-TIMESTAMP VALUE 917.

       78 SQLM-ELM-ACT-TOTAL VALUE 918.

       78 SQLM-ELM-WLO-COMPLETED-TOTAL VALUE 919.

       78 SQLM-ELM-CONCURRENT-WLO-TOP VALUE 920.

      * The full name of the monitor element is SQLM_ELM_CONCURRENT_WLO_ACT_TOP
       78 SQLM-ELM-WORKLD-CONC-WLOACTTOP VALUE 921.

       78 SQLM-ELM-TOP VALUE 922.

       78 SQLM-ELM-BOTTOM VALUE 923.

       78 SQLM-ELM-HISTOGRAM-TYPE VALUE 924.

       78 SQLM-ELM-BIN-ID VALUE 925.


       78 SQLM-ELM-ACTIVITY-ID VALUE 926.

       78 SQLM-ELM-ACTIVITY-SECONDARY-ID VALUE 927.

       78 SQLM-ELM-UOW-ID VALUE 928.

       78 SQLM-ELM-PARENT-ACTIVITY-ID VALUE 929.

       78 SQLM-ELM-PARENT-UOW-ID VALUE 930.

       78 SQLM-ELM-TIME-OF-VIOLATION VALUE 931.

       78 SQLM-ELM-ACTIVITY-COLLECTED VALUE 932.

       78 SQLM-ELM-ACTIVITY-TYPE VALUE 933.

       78 SQLM-ELM-THRESHOLD-PREDICATE VALUE 934.

       78 SQLM-ELM-THRESHOLD-ACTION VALUE 935.

       78 SQLM-ELM-THRESHOLD-MAXVALUE VALUE 936.

       78 SQLM-ELM-THRESHOLD-QUEUESIZE VALUE 937.

      * The full name of the monitor element is SQLM_ELM_COORD_ACT_COMPLETED_TOTAL
       78 SQLM-ELM-COORD-ACT-COMP-TOT VALUE 938.

      * The full name of the monitor element is SQLM_ELM_COORD_ACT_ABORTED_TOTAL
       78 SQLM-ELM-COORD-ACT-ABOR-TOT VALUE 939.

      * The full name of the monitor element is SQLM_ELM_COORD_ACT_REJECTED_TOTAL
       78 SQLM-ELM-COORD-ACT-REJ-TOT VALUE 940.

      * The full name of the monitor element is SQLM_ELM_COORD_ACT_LIFETIME_TOP
       78 SQLM-ELM-COORD-LIFETIME-TOP VALUE 941.

       78 SQLM-ELM-ACT-EXEC-TIME VALUE 942.

       78 SQLM-ELM-TIME-CREATED VALUE 943.

       78 SQLM-ELM-TIME-STARTED VALUE 944.

       78 SQLM-ELM-TIME-COMPLETED VALUE 945.

       78 SQLM-ELM-SECTION-ENV VALUE 946.

       78 SQLM-ELM-ACTIVATE-TIMESTAMP VALUE 947.

      * The full name of the monitor element is SQLM_ELM_NUM_THRESHOLD_VIOLATIONS
       78 SQLM-ELM-NUM-THRESHOLD-VIOLAT VALUE 948.

       78 SQLM-ELM-ARM-CORRELATOR VALUE 949.

       78 SQLM-ELM-PREP-TIME VALUE 950.

       78 SQLM-ELM-QUEUE-SIZE-TOP VALUE 951.

      * The full name of the monitor element is SQLM_ELM_QUEUE_ASSIGNMENTS_TOTAL
       78 SQLM-ELM-QUEUE-ASSIGNMENTS-TOT VALUE 953.

       78 SQLM-ELM-QUEUE-TIME-TOTAL VALUE 954.

       78 SQLM-ELM-LAST-WLM-RESET VALUE 955.

       78 SQLM-ELM-THRESHOLD-DOMAIN VALUE 956.

       78 SQLM-ELM-THRESHOLD-NAME VALUE 957.

       78 SQLM-ELM-THRESHOLDID VALUE 958.

       78 SQLM-ELM-NUMBER-IN-BIN VALUE 959.

      * The full name of the monitor element is SQLM_ELM_COORD_ACT_LIFETIME_AVG
       78 SQLM-ELM-COORD-ACT-LIFETIM-AVG VALUE 960.

      * The full name of the monitor element is SQLM_ELM_COORD_ACT_QUEUE_TIME_AVG
       78 SQLM-ELM-COORD-ACT-Q-TIME-AVG VALUE 961.

      * The full name of the monitor element is SQLM_ELM_COORD_ACT_EXEC_TIME_AVG
       78 SQLM-ELM-COORD-ACT-EXECTIM-AVG VALUE 962.

      * The full name of the monitor element is SQLM_ELM_COORD_ACT_EST_COST_AVG
       78 SQLM-ELM-COORD-ACT-ESTCOST-AVG VALUE 963.

      * The full name of the monitor element is SQLM_ELM_COORD_ACT_INTERARRIVAL_TIME_AVG
       78 SQLM-ELM-COORD-ACT-IA-TIME-AVG VALUE 964.

       78 SQLM-ELM-REQUEST-EXEC-TIME-AVG VALUE 965.


      *****************************************************************************
      * New elements for JITS                                                      *
      *****************************************************************************
       78 SQLM-ELM-STATS-CACHE-SIZE VALUE 966.

       78 SQLM-ELM-STATS-FABRICATIONS VALUE 967.

       78 SQLM-ELM-STATS-FABRICATE-TIME VALUE 968.

       78 SQLM-ELM-SYNC-RUNSTATS VALUE 969.

       78 SQLM-ELM-SYNC-RUNSTATS-TIME VALUE 970.

       78 SQLM-ELM-ASYNC-RUNSTATS VALUE 971.


      * Memory Pool List element                                                   *
       78 SQLM-ELM-POOL-LIST-ID VALUE 972.


       78 SQLM-ELM-IS-SYSTEM-APPL VALUE 973.
      ...
      * The full name of the monitor element is SQLM_HI_VAL_TSCONT_INACCESSIBLE
       78 SQLM-HI-VAL-TSCONT-INACCESSIB VALUE 0.

       78 SQLM-HI-VAL-TSCONT-ACCESSIBLE VALUE 1.
      ...
      *****************************************************************************
       ...
       78 SQLM-HMON-OPT-COLL-FULL VALUE 1.
      ...
      *****************************************************************************
       ...
       78 SQLM-INSTREAM-ELM-DBNAME VALUE 128.

       78 SQLM-INSTREAM-ELM-APPLID VALUE 129.

       78 SQLM-INSTREAM-ELM-AGENTID VALUE 130.


      *****************************************************************************
      * Snapshot Request Stream Request Flag Actions                               *
      *****************************************************************************
       78 SQLM-INSTREAM-ADD-REQUEST VALUE 1.

       78 SQLM-INSTREAM-ADD-QUALIFIER VALUE 2.

       78 SQLM-INSTREAM-ADD-REQQUAL VALUE 3.
