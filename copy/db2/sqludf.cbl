      ...
      * Sun/X86
       78  SQLUDF-PLATFORM-SUNX86    VALUE    33.
      * Sun/X8664
       78  SQLUDF-PLATFORM-SUNX8664  VALUE    34.
      * DARWIN
       78  SQLUDF-PLATFORM-DARWIN    VALUE    35.
      * AS/400
      ...
      * InspurKUX
       78  SQLUDF-PLATFORM-INSPURKUXI64 value 26.
      ...
      * Database Partition number of where executing
           05 DBPARTITIONNUM         PIC 9(9) COMP-5.
      * number of entries in dbpartitions field
           05 NUMDBPARTITIONS        PIC 9(4) COMP-5.
           05 FILLER                 PIC X(2).
      * dbpartitions will be allocated dynamically for array of partitions
      * in partition group when TF is processed in parallel; otherwise, this
      * will be a null pointer
           05 DBPARTITIONS           USAGE IS POINTER.
      * Reserved for expansion
           05 RESD3                  PIC X(4).
           05 FILLER                 PIC X(4).
