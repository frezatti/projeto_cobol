      ...
      * Specifies whether or not the query is executed using asynchrony
       78  SQLA-FEDASYNC-OPT         value    89.
      * Specifies to use currently committed data or to wait for results
       78  SQLA-CONCURRENTAR-OPT     value    92.
      ...
      * already exists - bind, rebind and precompile option
       78  SQLA-APREUSE-OPT          value    93.
      * Specifies extended indicator support
       78  SQLA-EXTENDEDINDICATOR-OPT value   94.
      * Specifies whether or not this statement will replace temporal table
      * queries with an AS OF value equal to special register CURRENT
      * TEMPORAL BUSINESS_TIME
       78  SQLA-BUSTIMESENSITIVE-OPT value    96.
      * Specifies whether or not this statement will replace temporal table
      * queries with an AS OF value equal to special register CURRENT
      * TEMPORAL SYSTEM_TIME
       78  SQLA-SYSTIMESENSITIVE-OPT value    97.
      ...
      * CODEUNITS32 - bind and precompile option.
       78  SQLA-STRING-UNITS-OPT     value    100.
      ...
      * Maximum sqlchar length for option[n].val when option[n].type is
      * SQLA_COLLECTION_OPT
       78  SQLA-MAX-COLLECTION       value    128.
      ...
      * Maximum sqlchar length for option[n].val when option[n].type is
      * SQLA_OWNER_OPT
       78  SQLA-MAX-OWNER            value    128.

      * Maximum sqlchar length for option[n].val when option[n].type is
      * SQLA_SCHEMA_OPT
       78  SQLA-MAX-SCHEMA           value    128.

      * Maximum sqlchar length for option[n].val when option[n].type is
      * SQLA_QUALIFIER_OPT
       78  SQLA-MAX-QUALIFIER        value    128.

      * Maximum sqlchar length for option[n].val when option[n].type is
      * SQLA_CATALOG_OPT
       78  SQLA-MAX-CATALOG          value    128.
      ...
      * Maximum sqlchar length for option[n].val when option[n].type is
      * SQLA_GENERIC_OPT
       78  SQLA-MAX-GENERIC          value    4096.
      ...
      * Maximum sqlchar length for option[n].val when option[n].type is
      * SQLA_FUNCTION_PATH
       78  SQLA-MAX-FUNCPATH         value    2048.
      ...
      * Any static cursor that does not contain the FOR UPDATE or FOR DELETE
      * clause will be considered READ ONLY. and insensitive
       78  SQLA-STATICRO-INSENSITIVE value    2.
      * Values used for option[n].val when option[n].type is
      * SQLA_FEDASYNC_OPT.
      * No asynchrony is used
       78  SQLA-FEDASYNC-MIN         value    0.
      * Allows the optimizer to determine the level of asynchrony.
       78  SQLA-FEDASYNC-ANY         value    -1.
      * Maximum value
       78  SQLA-FEDASYNC-MAX         value    32767.

      * Values used for option[n].val when option[n].type is
      * SQLA_STRING_UNITS_OPT
      * The default STRING_UNITS for character-based type specifications in
      * the statement will be SYSTEM.
       78  SQLA-STRING-UNITS-SYS     value    0.
      * The default STRING_UNITS for character-based type specifications in
      * the statement will be CODEUNITS32.
       78  SQLA-STRING-UNITS-CU32    value    1.
      ...
      * Request the outer precompiler to get the next function SQL statement
       78  SQLA-NEXT-FUNCTION-STMT   VALUE    25.
      ...
      * Values assigned to stmt_type, an output parameter of SQLACMPL.
       ...
       78  SQLA-TYPE-CONNECT-ACCESSTOKEN VALUE 196.
       78  SQLA-TYPE-CONNECT-APIKEY  VALUE    197.
      ...
      * length of precompiler pid for V7.1 to V9
       78  SQL-PID-LENGTH-V71        VALUE    162.
      * length of precompiler pid
       78  SQL-PID-LENGTH            VALUE    292.
      * minimum length of precompiler pid
       78  SQL-MIN-PID-LENGTH        VALUE    164.
      ...
      * Values returned in sqlca.sqlcode by Precompiler or Runtime Services
       ...
       78  SQLA-RC-NO-STRUCT         VALUE    -312.
      ...
      * Prep version of -504
       ...
       78  SQLA-RC-COMPAT-MODE-NOT-SET VALUE  -1696.
      ...
      * Program ID.  Used by Precompiler Services and Runtime Services
       ...
       01 SQL-SQLA-PROGRAM-ID.
           ...
           05 SQL-BF-REL-NUM         PIC 9(4) COMP-5.
           05 SQL-CONTOKEN           PIC X(8).
           05 SQL-BUFFER             PIC X(16).
           05 SQLUSER-LEN            PIC 9(4) COMP-5.
           05 SQLUSER                PIC X(128).
           05 SQL-PLANNAME-LEN       PIC 9(4) COMP-5.
           05 SQL-PLANNAME           PIC X(128).
