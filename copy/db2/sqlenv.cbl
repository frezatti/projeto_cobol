      ...
      * SQL_USERID_SZ and SQL_MAX_USERID_SZ have been deprecated but are
      * kept to 
      * preserve compatibility. They may be removed in future release.
      * Customers 
      * should define their own constants according to section <User, user
      * ID and 
      ...
      * communication buffer exit library name
       78  SQL-COMM-EXIT-NAME-SZ     VALUE    32.
      * communication buffer exit library list
       78  SQL-COMM-EXIT-LIST-SZ     VALUE    128.
      ...
      * CA Transport Device Name
       78  SQL-CA-XPORT-DEV-SZ       VALUE    15.
      * Connect licence version
       78  SQL-LICVERSION-SZ         VALUE    8.
      ...
      * from IBM DBMS.
       ...
       78  SQL-DBMS-DB2-LINUXPPC64LE value    "QDB2/LINUXPPC64LE".
       78  SQL-DBMS-DB2-LINUXPPC     value    "QDB2/LINUXPPC".
       78  SQL-DBMS-DB2-LINUXIA64    value    "QDB2/LINUXIA64".
       78  SQL-DBMS-DB2-INSPURKUXI64 value    "QDB2/INSPURKUXI64".
      ...
      * Max supported protocol
       78  SQL-PROTOCOL-MAX          VALUE    x"0E".
      ...
      * Hostname validation is off
       78  SQL-HOSTNAME-VALIDATION-OFF VALUE  0.
      * Basic hostname validation following RFC6125 is performed for TLS
      * connections (Default)
       78  SQL-HOSTNAME-VALIDATION-BASIC VALUE 1.
      * APPTOKEN generation options
      * APPTOKEN generation is off (Default)
       78  SQL-APPTOKENGEN-OFF       VALUE    0.
      * APPTOKEN generation is on
       78  SQL-APPTOKENGEN-ON        VALUE    1.

      * ClientGSKitLocation options
      * Force GSKit loading by fully qualified name
       78  SQL-STOCK                 VALUE    1.
      ...
      * Auth via Kerberos or Server with Encrypt (Valid only at the server
      ...
      * Same as SQL_AUTHENTICATION_SVR_ENCRYPT but will only encrypt with
      * AES encryption.
       78  SQL-AUTHENTICATION-SVRENC-AESO VALUE 13.
      * Auth using Transport Layer Security Client Certificate
      * Authentication Security mechanism
       78  SQL-AUTHENTICATION-CERTIFICATE VALUE 14.
      * Authentication using a token
       78  SQL-AUTHN-TOKEN           VALUE    15.
      * Authentication using Server with Encrypt or a token
       78  SQL-AUTHN-SVR-ENCRYPT-TOKEN VALUE  16.
      * Authentication using Kerberos or a token
       78  SQL-AUTHN-KERBEROS-TOKEN  VALUE    17.
      * Authentication using Kerberos or Server with Encrypt or a token
       78  SQL-AUTHN-KRB-SVR-ENC-TOKEN VALUE  18.
      * Authentication using GSS API plugin or a token
       78  SQL-AUTHN-GSSPLUGIN-TOKEN VALUE    19.
      * Authentication using GSS API plugin or Server with Encrypt or a
      * token
       78  SQL-AUTHN-GSS-SVR-ENC-TOKEN VALUE  20.
      * Authentication Not Specified
       78  SQL-AUTHENTICATION-NOT-SPEC VALUE  255.

      * Alternate Authentication Encryption Algorithm
      * Alternate auth via Server with Encrypt using AES algorithm only
      * (Valid only at server)
       78  SQL-ALTERNATE-AUTH-ENC-AES VALUE   0.
      * Alternate auth via Server with Encrypt using AES or DES algorithm
      * (Valid only at server)
       78  SQL-ALTERNATE-AUTH-ENC-AES-CMP VALUE 1.
      * Alternate Authentication Not Specified
       78  SQL-ALTERNATE-AUTH-ENC-NOTSPEC VALUE 255.
      ...
      * Using RDMA
       78  SQL-CF-TRANSPORT-RDMA     VALUE    0.
      * Using TCP
       78  SQL-CF-TRANSPORT-TCP      VALUE    1.
      ...
      * Binary collation for Unicode (CP 1208) databases only
       78  SQL-CS-BINARY             VALUE    -15.

      * Defines for iQOptions field of db2InsQuiesceStruct and iQOptions
      * field of db2QuiesceStartStruct
      * Instance quiesced in restricted access mode
       78  DB2INSQUIESCE-RESTRICTEDACCESS VALUE x"01".
      ...
      * Database Manager OPTION and CALLERAC parameters
       ...
       78  SQLE-CONTINUE             VALUE    4.
       78  SQLE-TERMINATE            VALUE    8.
       78  SQLE-ADDNODE              VALUE    16.
       78  SQLE-RESTART              VALUE    32.
       78  SQLE-STANDALONE           VALUE    64.
       78  SQLE-RESTART-LIGHT        VALUE    128.
       78  SQLE-HOST                 VALUE    256.
       78  SQLE-QUIESCE              VALUE    65536.
      * From here on, internal options only
       78  SQLE-SKELETON             VALUE    512.
       78  SQLE-CM-INVOKE            VALUE    1024.
       78  SQLE-MEMBER               VALUE    2048.
       78  SQLE-CF                   VALUE    4096.
       78  SQLE-NODENUM              VALUE    8192.
       78  SQLE-ADDCA                VALUE    16384.
       78  SQLE-DROPCA               VALUE    32768.
       78  SQLE-UPDATE               VALUE    131072.
      ...
      * default analytics extent size
       78  SQL-DEF-EXTSIZE-ANALYTICS VALUE    4.
      ...
      * Client correlation token
       78  SQLE-CLIENT-INFO-CORR-TOKEN VALUE  7.
      ...
      * Maximum client accounting information length
       78  SQLE-CLIENT-ACCTSTR-MAX-LEN VALUE  255.
      ...
      * Maximum length for client correlation token
       78  SQLE-CLIENT-CORR-TOKEN-MAX-LEN VALUE 255.
      ...
      * version 3 database descriptor
       78  SQLE-DBDESC-3             value    "SQLDBD03".
      ...
      * sqledbdesc structure dbflags
       78  SQL-DB-DATALAKE-ENABLED   VALUE    1.
      ...
      * QUIESCE timeout
           05 SQL-IQUIESCEDEFERMINUTES PIC S9(9) COMP-5.
      ...
      * HADR standby is rejected by primary
       78  SQLE-RC-STANDBY-REJECTED  VALUE    -1028.
      ...
      * Quiesce already active
       78  SQLE-RC-ALREADY-QUIESCED  VALUE    1371.
      * Unquiesce failed
      ...
      * Upgrade complete with warning code
       78  SQLE-RC-UPGRADE-WARN      VALUE    1708.

      * The member or CF failed to start due to an invalid netmon.cf file
       78  SQLE-RC-INVALID-NETMONCF  VALUE    -1786.
      ...
      * Db is in IO Suspend mode.
       78  SQLE-RC-DEACT-DB-IOSUSPENDED VALUE 1649.
      * Invalid parameter
      ...
      * One or more CF ports failed
       78  SQLE-RC-HCA-DOWN          VALUE    1659.
      ...
      * Add Node is not allowed because a conflicting command is  in
      * progress
       78  SQLE-RC-ADD-NODE-CRDP     VALUE    -6074.
      * Add Node operation successful
       78  SQLE-RC-ADD-NODE-OK       VALUE    6075.
      * Online add node failed
       78  SQLE-RC-ONLINEADDNODE-OPERERR VALUE -1483.
      * A conflicting command is not allowed while add node is running
       78  SQLE-RC-ADDNODE-RESTRICTED VALUE   -1484.
      * State of the instance does not allow online add node to proceed
       78  SQLE-RC-ONLINEADDNODE-STATERR VALUE -1485.
      * A node is added offline to a single node instance
       78  SQLE-RC-ADDNODE-DONEOFFLINE VALUE  1487.
      * A node is added  to an instance managed by the DB2 Cluster Manager
       78  SQLE-RC-ADDNODE-DONEINCLUSTER VALUE 1488.
      * A node is added online successfully
       78  SQLE-RC-ONLINEADDNODE-DONE VALUE   1489.
      * Cluster resources are inconsistent
       78  SQLE-RC-CM-INCONSISTENT   VALUE    -1517.
      * An application with oldview of the instance exists.
       78  SQLE-RC-OLDVIEWAPP-EXIST  VALUE    -1524.
      * The last CA cat not be dropped.
       78  SQLE-RC-LAST-CF           VALUE    -1529.
      * The last member cat not be dropped.
       78  SQLE-RC-LAST-MEMBER       VALUE    -1541.
      * The maximum number of CA's in the DB2 instance has been reached.
       78  SQLE-RC-MAXNUM-CF         VALUE    -1542.
      * The host specified for the CA is a duplicate
       78  SQLE-RC-HOST-HAS-CF       VALUE    -1543.
      * Backup of a database following a topology change cannot be performed
      * from a newly added member.
       78  SQLE-RC-TOPOLOGY-BACKUP   VALUE    -1544.
      * Restore of a database image from a previous topology is not
      * supported
       78  SQLE-RC-TOPOLOGY-RESTORE  VALUE    -1545.
      * Rollforward through an add or drop member operation is not permitted
       78  SQLE-RC-TOPOLOGY-ROLLFORWARD VALUE -1546.
      * Recovery is needed for a previously failed add or drop operation.
       78  SQLE-RC-ADDDROP-RECOVERY  VALUE    -1547.
      * Rollforward cannot be initiated from a member that is not in the
      * current database topology
       78  SQLE-RC-RFWD-WRONG-MEMBER VALUE    -1714.
      * The operation cannot be performed because the source member topology
      * and the target member topology have no common member
       78  SQLE-RC-TOP-NO-COMMON-MEMBER VALUE -1710.
      * The command failed because the source and target member topologies
      * are not at the same DB2 product level
       78  SQLE-RC-TOP-UPGRADE       VALUE    -1712.
      * Error in starting up with the current CF_TRANSPORT_METHOD database
      * manager configuration parameter
       78  SQLE-RC-CF-TRANSPORT-ERROR VALUE   -1721.
      * Ethernet card speed does not meet the 10GE minimum
       78  SQLE-RC-10GE-CARD-RESTRICTION VALUE -1726.
      ...
      * DB2 Cluster Services failed to update the states of resources
       78  SQLE-RC-CLUSTER-MGR-FAILED VALUE   -1677.
      * The CF host was previously stopped by db2stop INSTANCE ON command
       78  SQLE-RC-CF-HOST-STOPPED   VALUE    1678.
      * The CF host can't be reached
       78  SQLE-RC-CF-HOST-UNREACHED VALUE    -1679.
      * The member is performing recovery or resolving in-doubt transaction
       78  SQLE-RC-GUEST-STOP-FAILED VALUE    -1687.
      * The member host can't be reached, member will be started as guest
      * member
       78  SQLE-RC-MEMBER-HOST-UNREACHED VALUE 1680.
      * The member host was previously stopped, member will be started as
      * guest member
       78  SQLE-RC-MEMBER-HOST-STOPPED VALUE  1681.
      * The CF contains dirty pages or holds locks
       78  SQLE-RC-CF-NOT-STOPPABLE  VALUE    -1688.
      * The member is started as guest member
       78  SQLE-RC-MEMBER-START-LIGHT VALUE   1682.
      * The home host has not started yet when the member is stopped
       78  SQLE-RC-HOME-HOST-NOT-STARTED VALUE 1689.
      * The host can't be reached during db2stop member or CF
       78  SQLE-RC-HOST-UNREACHED    VALUE    -1690.
      * The active member or CF is running on the host
       78  SQLE-RC-MEMBER-OR-CF-RUNNING VALUE -1691.
      * Restart light animation failed
       78  SQLE-RC-RESTART-LIGHT-FAILED VALUE -1683.
      * The idle process failed to start
       78  SQLE-RC-IDLE-START-FAILED VALUE    -1684.
      * The idle process failed to stop
       78  SQLE-RC-IDLE-STOP-FAILED  VALUE    -1692.
      * The member failed to start because CF failed to start
       78  SQLE-RC-MEMBER-CF-NOT-STARTED VALUE -1685.
      * The instance on the host failed to start
       78  SQLE-RC-HOST-START-FAILED VALUE    -1686.
      * The isntance on the host failed to stop
       78  SQLE-RC-HOST-STOP-FAILED  VALUE    -1693.
